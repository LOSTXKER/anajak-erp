...
## ใบผลิตตัวอย่าง "ทุกสถานะของฟอร์ม" (ORD-<งวด>-0016 … 0025 · `prisma/seed-demo-form-states.ts`)

ชื่อลูกค้า = ชื่อสถานะ เห็นได้จากหน้ารายการผลิตและหัวใบ · เปิดตรง `/production/demo-production-form-<key>`

| # | key | เห็นอะไร |
|---|---|---|
| 1 | `start` | รอเริ่มขั้นแรก — ปุ่มบนหัวใบ "เริ่มทำ" |
| 2 | `doing` | กำลังทำ ติ๊ก 1/3 ยอด 20/60 — ปุ่มปิดขั้นกดไม่ได้จนติ๊กครบ |
| 3 | `ready-close` | ติ๊กครบ ยอดครบ — ปุ่ม "ปิดขั้นนี้" กดได้ |
| 4 | `hold` | พักไว้ — เมนู ⋯ "คืนขั้นนี้กลับคิว" |
| 5 | `problem` | ติดปัญหา — การ์ดแดง ปุ่ม "จัดการปัญหา" |
| 6 | `outsource` | ของอยู่ร้านปัก นัดรับอีก 3 วัน — ปุ่ม "รับงานกลับ" |
| 7 | `pair` | ช่องคู่ — ราง "พับ + ติดป้ายไซซ์ + ปักแขน" ช่องเดียว |
| 8 | `reopen` | ขั้นแรกปิดแล้ว — เมนู ⋯ "ย้อนกลับไป รีดร้อน" |
| 9 | `all-done` | ครบทุกขั้น — ปุ่ม "ส่งเข้า QC" |
| 10 | `in-qc` | ส่งเข้า QC แล้ว — ฟอร์มอ่านอย่างเดียว |
