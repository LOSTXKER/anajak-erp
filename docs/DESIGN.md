...
### Station work center และ flow (กติกาที่จอสถานี `/station` รักษา — จอเดิม `/factory/station` ถอดออก 2026-09-02)
