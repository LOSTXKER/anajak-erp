...
ใน panel เส้น 1px มุม 8px โดยไม่มีเงาตกแต่ง · **ตารางระดับบนสุดอยู่ในการ์ดเสมอ** — เคยลองแบบวางบน
ผืนหน้าตรง ๆ แล้วเบสตีกลับ 2026-08-26 ("ดูแปลกๆ และไม่ชอบ") จึงคืนกล่องครอบและถ่างผืนหน้าให้เป็น
เทาจริงเพื่อให้การ์ดมีพื้นให้ยืน · menu/dialog เป็นชั้นลอยสูงสุด ·
...
> บันไดพื้นผิวธีมสว่างถ่างใหม่ 2026-08-26: chrome `#f0f1f3` < ผืนหน้า `#f1f2f4` < การ์ด `#ffffff`
> การ์ดต่างจากผืนหน้า 1.12 เท่า (เดิม 1.03 เท่า = มองไม่เห็นว่าเป็นกล่อง) · สิ่งที่แยกเมนูซ้ายกับแถบบน
> ออกจากเนื้อหาคือ **เส้นขอบ** ไม่ใช่สีพื้น — ถ้าถ่าง chrome เข้มกว่านี้ hover ของมันต้องเข้มตาม
> แล้วตัวหนังสือ muted จะตกเกณฑ์ 4.5:1 · ธีมมืดไม่แตะ
