...
> |---|---|---|---|
> | สว่าง | `#ffffff` ขาวเท่าการ์ด | `#f1f2f4` โต๊ะเทา | `#ffffff` |
> | มืด | `#0a0a0b` จมใต้ผืนงาน | `#0e0e10` | `#161618` |
>
> การ์ดต่างจากผืนงาน 1.12 เท่าในธีมสว่าง (เดิม 1.03 เท่า = มองไม่เห็นว่าเป็นกล่อง)
> ธีมมืดยังต่างกัน 1.07 เท่า และแยกด้วยเส้นขอบเป็นหลัก — หนี้ที่รู้ตัว ไม่ใช่ของหลุด
> ประวัติ: กรอบขาว (08-03) → กรอบเทา (08-25 เฟส 1) → **กรอบขาวอีกครั้ง (08-26 เบสสั่งตรง)**
> คราวนี้ต่างจาก 08-03 ตรงที่ผืนงานเป็นเทาจริงแล้ว กรอบขาวจึงมีพื้นให้ตัดกัน ไม่ใช่ขาวบนขาว
