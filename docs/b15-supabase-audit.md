...
> **เบสเคาะ 2026-07-07: ไม่อัปเกรด Pro (ใช้แผนฟรีต่อ — ฟรีไม่มี backup อัตโนมัติเลย)**
> ทางแทน: **ระบบ export ในแอป** — ตั้งค่า → สำรองข้อมูล (เจ้าของกดได้ไฟล์ JSON ทุกตาราง
> snapshot เวลาเดียวกัน + audit ทุกครั้ง · แนะนำกดเก็บสัปดาห์ละครั้ง+หลังปิดเดือน) ·
> backup มือก้อนแรกด้วย pg_dump เก็บแล้วที่เครื่องเบส `~/Backups/anajak-erp-db/` (2026-07-07) ·
> ถ้าวันหน้าธุรกิจโต/ทีมพึ่งระบบมากขึ้น ค่อยทบทวนอัปเกรด Pro (ข้อความเดิมด้านล่างคงไว้อ้างอิง)
`Database → Backups`
