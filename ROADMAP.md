...
- [ ] **งานแก้และเคลมหลังลูกค้ารับของ** (เบสสั่ง 2026-09-18 · อนุญาตให้รื้อถึงราก) — **ก้อน 0 ขึ้นเว็บแล้ว** (`7a8d5aa`): ปิดรู 5 จุดที่ทำให้ประวัติรายการหายและของตีกลับไม่เหลือร่องรอย (เกณฑ์ถาวร 2 ข้ออยู่ใน SPEC) · เหลือก้อน 1-4 ที่ต้อง migration: ใบเคลม+คิวบนจอ+หน้าลูกค้าพูดได้ · ใบส่งผูกรายการจริง · แก้รายการใต้ใบเคลม+บังคับใบลดหนี้/เพิ่มหนี้ · เส้นเชื่อมออเดอร์ · **ฐานจริงยังว่าง (ลูกค้า/ออเดอร์/ใบกำกับ = 0 เมื่อ 2026-09-18) — รื้อโครงข้อมูลตอนนี้ถูกที่สุด หลังมีออเดอร์จริงใบแรกจะแพงขึ้นถาวร** · คู่มือ 80 เคส/9 วิธีจัดการ: https://claude.ai/artifact/MtyRHyJgxr9KGxtvQhTHzY · รอเบสเคาะนโยบาย 5 ข้อ (รับเคลมกี่วัน · ยกเลิกแล้วริบอะไร · คืนเงินหรือเครดิต · ใครมีอำนาจให้ฟรี/ลด · ค่าของที่ทำทิ้งคิดใคร)
- ยังค้างจากของที่ขึ้นเว็บแล้ว: ปุ่มย้อนหน้าผลิตยังไม่รู้จัก V2 (V2 ยังไม่เปิดจึงไม่กระทบ) · เลขรายการในกล่อง error ไม่ขยับตาม · ลบชุดงานยังไม่มีถามยืนยัน · `work-order-page.tsx` เป็นเชลล์หน้าลองที่ไม่ได้ใช้จริง รอเคาะว่าจะลบ · ชื่อบริการพิมพ์ในฐานจริงยังเป็นอังกฤษ ต้องแก้เองที่ ตั้งค่า → บริการ · ยังไม่มีใครพิมพ์ใบกำกับจริงออกมาดูสักใบ (โดยเฉพาะนิติบุคคลที่ไม่มีชื่อผู้ติดต่อ)
