...
- [ ] **A16: พักการออกแบบหน้าแรก รอเริ่มใหม่** — เบสสั่งลบต้นแบบหน้าแรกที่ลองล่าสุดและพักไว้ก่อน; ยังไม่มีทิศใหม่ที่เลือก
- ทำถึงไหน: ลบหน้าต้นแบบหน้าแรก ข้อมูลตัวอย่าง CSS รายการในทะเบียน ภาพและหลักฐานทดลองเฉพาะชุดนี้แล้ว; หน้าจริงและหน้าลองอื่นคงเดิม
- ตรวจแล้ว: typecheck, lint (0 errors/22 warnings เดิม), 183 files/1,840 tests และ verify:ui ผ่าน; เปิดลิงก์ที่ลบได้ 404 และหน้ารวมเหลือหน้าลองอื่น 4 รายการ
- ติดอะไร: ไม่มีข้อขัดข้องทางเทคนิค; งานออกแบบหน้าแรกพักตามคำสั่งเบส
- ทำต่อ: รอเบสเริ่มออกแบบใหม่ก่อนสร้างต้นแบบหรือขยายหน้าจริง
