...
- [ ] **PC4 ด่านก่อนเคลมเสร็จ (ทุกก้อน)** — typecheck, lint, unit, `verify:ui`, Impeccable detector และ build ผ่าน · browser จริง 1440×900 + 390×844 ทั้ง Light/Dark: ไม่มี horizontal overflow, console error, hydration, action ทับกัน · เป้ากดจอทัช ≥44px · keyboard focus/aria/reduced-motion ครบ · loading/error/empty/ไม่มีสิทธิ์ แยกกันจริง · อัปเดต `docs/DESIGN.md`, surface brief, `PROGRESS.md` และ commit ก้อนเล็ก
