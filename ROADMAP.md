...
- ตรวจ browser รอบนี้บน demo: ออเดอร์ 1440/390 ทั้ง Light/Dark ป้ายหมายเหตุและปัญหาสต๊อกมาก่อนหัวใบ. คลิกแท็บรายการแล้ว URL ตรง ลูกศรคีย์บอร์ดกลับภาพรวมได้ มือถือเปิดประวัติแล้วเลื่อนแท็บสุดท้ายเข้ามาเห็นครบ; เส้นใต้ active 2px สีน้ำเงินและพื้นโปร่งใส ไม่มีหน้าล้นแนวนอน. คืนธีมสว่าง/ขนาดจอเดิมหลังตรวจ
- ด่านตรวจ: typecheck ผ่าน; lint 0 errors/23 warnings; 201 files/1,967 tests ผ่าน; verify:ui 255 + work-order 32 ผ่าน. ทบทวน diff ยืนยันป้ายทั้งสี่ย้ายโดยไม่เปลี่ยนเงื่อนไข/คำสั่ง; คงสิทธิ์แท็บ สถานะ URL และ panel ที่เก็บ draft. Log `tabs-*` อยู่ `.tmp-test/ui-polish-20260913/` ไม่เข้า Git
