...
- ทำถึงไหน: main = ฟอร์มออเดอร์ครบตามต้นแบบ ขึ้นเว็บจริง (เบสสั่ง merge 2026-09-18) · 2026-09-16 เบสสั่งทุกหน้าตามต้นแบบ 100% ยกเว้นออเดอร์/ผลิต โดยคงฟีเจอร์จริง → เทียบ 44 หน้า แก้ 353 จุด ขึ้นแล้ว (รอบแรกตรงแค่ 57/182 จุด เบสทักเอง — port ต้องเทียบทีละชิ้นก่อนบอกว่าเสร็จ)
  - ของที่ขึ้นแล้ว: เมนูซ้ายชุดใหม่ทั้งเว็บ (6 กลุ่ม · เลขงานค้างจาก query จริง) · PageShell/PageHeader ชุด kit เดียว ทุกหน้ากว้างเท่ากัน · `rowToneFor` เส้นสีซ้ายของแถว · รายหน้า 30 หน้า (หน้าแรก · งานของฉัน · ใบเสนอราคา · ลูกค้า · สินค้า · การเงิน 5 · รายงาน · แจ้งเตือน · ตั้งค่า 12 · เข้าสู่ระบบ · ลิงก์ลูกค้า 5 · เอกสารพิมพ์ 5) · ฟอร์มออเดอร์ทั้งใบ
- ตรวจแล้ว: typecheck · lint 0 error (เตือน 17 เท่าเดิม) · test 1877 ผ่าน · verify:ui ผ่านครบ · ฟอร์มออเดอร์วางภาพคู่ต้นแบบนอก Next ครบ 4 แท็บ × เปิดงาน/แก้ไข + หน้าว่าง + 500px + มืด และลองกดจริง · **ยังไม่ได้เปิดหน้าจริงที่ล็อกอิน**
...
- ทำต่อ: **ฟอร์มออเดอร์ขึ้นเว็บจริงครบถึงไอคอนหัวข้อย่อย + ปุ่มคัดลอกรายการ (merge 2026-09-18) · รอเบสสั่ง merge บน `nami/priority-days-20260918`: ความเร่งด่วนบอกช่วงวัน** (เร่งด่วน ภายใน 1 วัน · สูง 2-3 · ปกติ 3-7 · ต่ำ 7-14 เก็บที่ `PRIORITY_DAY_HINTS` ที่เดียว · โผล่ในช่องเลือก ภาพรวมออเดอร์ ใบสั่งงาน ป้ายหัวใบผลิต · ป้ายเตือนในตาราง/การ์ดยังสั้นคำเดียว เพราะแถวมีวันกำหนดส่งแล้ว · `priorityFromDeadlineDays` เลื่อนเส้นเดาระดับตามนิยามใหม่ เดิม ≤3 วันขึ้นเร่งด่วน) · ยังค้าง: เลขรายการในกล่อง error ไม่ขยับตามเมื่อรายการเปลี่ยน (ของเดิม เกิดกับปุ่มลบด้วย) · ลบชุดงานยังไม่มีถามยืนยัน · ป้ายระดับ HIGH เขียนไม่ตรงกัน (ช่องเลือก "สูง" · ชิป/การ์ด "สำคัญ") รอเบสเคาะคำที่ใช้ · โมดูลผลิตไม่แตะ (หน้าใบผลิตยังใช้การ์ดชุดเก่า รอเคาะแยก)
