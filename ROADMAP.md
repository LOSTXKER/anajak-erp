...
- [ ] **หน้าลอง `/proto/production-module` ทำแล้ว (09-02) รอเบสเคาะ** — 3 ทาง: A โต๊ะงานหัวหน้า / B สายพาน / C ตารางเวลา · ทุกทางรวมจอสถานี (§A2) + รอบพิมพ์ + ร้านนอกไว้หน้าเดียว มีสวิตช์ "โหมดหน้างาน" (จอทัช 1024×768) · เคาะแล้ว → ลงของจริง (ต้องคืนทางเปิดใบผลิต + ตัดสินว่ารอบพิมพ์/คลังฟิล์มอยู่ตรงไหน)
