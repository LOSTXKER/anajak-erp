...
- 14 ก.ย. เบสถาม “แล้ว CTA หายไปไหน” → “CTA แบบเดิม” คือปุ่มขั้นต่อไปที่หัวหน้าออเดอร์ของระบบจริง (มุมขวาบน ก่อนปุ่มใบสั่งงาน) ใส่กลับทั้งรอบ 1 และรอบ 3 ด้วยชื่อ/ปุ่ม/ปลายทางชุดเดียวกับ `src/lib/order-next-step.ts` (เช่น ไปส่วนงานออกแบบ · ไปส่วนการผลิต · ส่งเข้าออกแบบ · แพ็คเสร็จ → พร้อมส่ง · ปิดงาน) ปุ่มลงมือจริง (เปิดใบผลิต/เริ่มผลิต/เพิ่มไฟล์พิมพ์) อยู่ที่จุดใช้ในแท็บงานผลิต; ลูกค้าอนุมัติแบบแล้วสถานะเป็นอนุมัติแบบแล้วเหมือนระบบจริง
