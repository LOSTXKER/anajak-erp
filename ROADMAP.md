...
- [ ] **ก้อน 2 · ยกฟอร์มเป็นชิ้นกลาง** — `useOrderForm()` + `<OrderForm mode>` · refactor เฉยๆ หน้าตา/พฤติกรรมห้ามเปลี่ยน
- [ ] **ก้อน 3 · โหมดแก้ “ข้อมูล + ที่อยู่”** แทน `OrderInfoEditDialog` ← จุดที่เบสเริ่มเห็น “UI เหมือนกัน” จริง · ลูกค้า/ช่องทางอ่านอย่างเดียว (โชว์เทาพร้อมเหตุผล ห้ามซ่อน) · ปิดร่าง localStorage + effect อัตโนมัติทั้งหมด · ช่องภาษี % กลับมา
