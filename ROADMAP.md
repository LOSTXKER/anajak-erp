...
- ทำถึงไหน: 2026-09-14 เบสสั่งรื้อ UX/UI แนว minimal modern (Notion/Vercel) มุมโค้ง มีลูกเล่น คงน้ำเงิน Anajak และฟอนต์ Prompt; ทำหน้าแรกเป็นต้นแบบก่อน. ต้นแบบ = HTML เดี่ยวในสมอง `records/projects/anajak-erp/mockup-home-minimal-2026-09-14.html` (artifact `b29b1705`) มีสวิตช์เทียบแบบเดิม 4 มุมมอง; โค้ดแอปยังเท่า `7691bf7`. เบสเคาะทิศแล้ว ปัดตัวเลขนับ "ต้องเช็กก่อน" และรายการงาน → รอบ 3 การ์ดซ้ายบนเป็นเรื่องโรงงาน 2 แบบ: ก ผังไหล (node จริงจาก `factory-station.ts`/`production-steps.ts`: ออกแบบ → เตรียมเสื้อ/พิมพ์ฟิล์ม/ร้านนอก → รีดร้อนรอฟิล์ม∧เสื้อ → QC → แพ็ก → ส่ง + คอขวด) / ข กระดานสุขภาพ (4 ข้อเท็จจริง + แถวต่อ node มีแถบงานในมือ/กำลังต่อวัน); รายการต้องจัดการเป็นคอลัมน์ในตารางออเดอร์
