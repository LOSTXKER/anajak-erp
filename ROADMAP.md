...
- ทำถึงไหน: main = `172f9b3` · **2026-09-16 เบสสั่ง "ทำแบบ proto นี้เลยแบบ 100% ทุกหน้าทุกส่วน ยกเว้นออเดอร์และการผลิต" พร้อมสั่งว่าฟีเจอร์จริงที่ต้นแบบทำหายให้เก็บไว้** → แตกโค้ดต้นแบบเป็นไฟล์รายหน้า 44 หน้า แล้วเทียบกับโค้ดจริงทีละช่อง พบส่วนต่าง 353 จุด (หนัก 58 กลาง 153 เบา 142) และไล่แก้ทั้งชุดบน `nami/ui-pages-20260916`
  - ไฟล์กลาง: เมนูซ้ายครบ 6 กลุ่มตาม NAV2 (เพิ่มเมนูย่อยการผลิต 4 ตัว + การแจ้งเตือน) · ป้าย/ไอคอนตรงต้นแบบ · ตัวเลขงานค้างท้ายเมนูจาก query จริง · เส้นคั่นกลุ่มท้าย · แถบผู้ใช้ท้ายราง · รางกาง 244px หุบ 78px แบบไอคอนบนชื่อล่าง · PageShell/PageHeader ใช้โครง kit ชุดเดียว ทุกหน้ากว้างเท่ากัน · เส้นสีซ้ายของแถวใช้ได้ทั้งตารางและการ์ดจอแคบ (`rowToneFor`)
  - รายหน้า: หน้าแรก · งานของฉัน · ใบเสนอราคา 3 หน้า · ลูกค้า 2 หน้า · สินค้า 2 หน้า · บิล · ลูกหนี้ · ใบวางบิล · ภาษีขาย · หัก ณ ที่จ่าย · รายงาน · แจ้งเตือน · ตั้งค่า 12 หน้า · เข้าสู่ระบบ · ลิงก์ลูกค้า 5 หน้า · เอกสารพิมพ์ 5 แบบ
...
- ทำต่อ: เบสเปิด preview ของ `nami/ui-pages-20260916` ไล่ดูทุกหน้า → เคาะว่า merge ขึ้น main ได้เลยหรือให้แก้จุดไหนก่อน · ออเดอร์กับการผลิต (รวมเส้นแดงในหน้าออเดอร์ที่เคยขอคืน) ยังไม่แตะตามที่สั่ง
