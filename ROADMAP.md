...
### รอทบทวนสามแท็บในต้นแบบออเดอร์

- คำขอล่าสุด 13 ก.ย. 2569: เบสชอบแนวใหม่ของ `/proto/order-workspace` แล้ว; เก็บสรุปราคาในแท็บรายการ พร้อมแท็บเงิน & บิล และม็อกอัพ & ไฟล์ครบแล้ว รอทบทวนส่วนที่จัดใหม่ก่อนนำไปต่อกับหน้าจริง
...
- สามส่วนใหม่: `?tab=items` คงตารางเดิมและรวมสรุปราคาเป็นแผงเดียว ยอดสุทธิเด่นพร้อมค่าใช้จ่าย/VAT; `?tab=money` เห็นยอดค้าง รับแล้ว และออกใบเรียกเก็บ แยกงวดชำระกับเอกสาร; `?tab=files` ภาพใหญ่คู่กับรายการต้นฉบับ/ไฟล์พิมพ์และแบรนด์ เลือกไฟล์ใกล้ภาพบนมือถือได้
...
- ตรวจรอบนี้: ดูสามส่วนบน 1440/390 และ Light/Dark, Prompt เดิม รูปโหลดครบ หน้าจอไม่ล้น; ลองรับ 1,000 จากค้าง 2,996 แล้วรับส่วนที่เหลือ ยอดสุดท้าย 0; ทดสอบยอด 0/เกินค้าง/ลบวันที่ด้วยคีย์บอร์ด ยกเลิกและเปิดเอกสาร สลับแท็บคงยอด เลือกไฟล์ข้อความ/ภาพ เติมไฟล์ว่าง และเปิดมุมมองลูกค้า. ไม่พบ console error; ตรวจ React และคำบนจอตาม ui-guidance แล้ว
- ด่านตรวจรอบนี้: typecheck ผ่าน; lint 0 errors/22 warnings เดิม; 201 files/1,971 tests ผ่าน; verify:ui 255 + work-order 32 ผ่าน. Log `tabs-refine-*` อยู่ `.tmp-test/ui-polish-20260913/` ไม่เข้า Git. สคริปต์ proto-shots เดิมไม่พบทั้งต้นฉบับและสำเนาติดตั้ง จึงตรวจภาพผ่าน browser โดยไม่ได้อ้างผลผ่านสคริปต์เก่า
- จุดต่อ: ทบทวนสามแท็บที่จัดใหม่ แล้วนำทิศที่เลือกไปต่อกับหน้าออเดอร์/หน้าแรกจริงตามขอบเขตที่อนุมัติ. งานอยู่ branch `codex/ui-focus-two-pages-20260913` ยังไม่ใช่ main/Production
