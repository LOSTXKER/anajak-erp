...
- [ ] **งานแก้และเคลมหลังลูกค้ารับของ** (เบสสั่ง 2026-09-18 · อนุญาตให้รื้อถึงราก) — **ก้อน 0 และก้อน 1 ขึ้นเว็บแล้ว** (`7a8d5aa` · `081b680` ลงฐานจริง 18 ก.ย. 69 สำรองที่ `~/Backups/anajak-erp-db/`) · ใช้ได้แล้ว: ใบเคลมรายไซซ์ · เปิดเองตอนตีกลับใบส่ง · สั่งงานแก้ปุ่มเดียว · ด่านปิดใบตามเอกสารเงิน · สิทธิ์ `decide_claims` · เหตุ `claim` ครบ 4 จอ · หน้าลูกค้า รับเรื่อง → กำลังแก้งาน → ส่งกลับให้ใหม่ · **เทสบนเว็บจริงครบวงจร 19 ก.ย. 69** เจอ 3 รู แก้แล้ว (`0178756`) · **ยังไม่มีใครใช้กับงานจริงสักใบ** (ฐานจริงยังว่าง) · **ก้อนถัดไป**: ตีกลับบางส่วน (2) · แก้รายการใต้ใบเคลม (3) · งานแก้บนใบผลิต → ดูข้อถัดไป · คู่มือ 80 เคส: https://claude.ai/artifact/MtyRHyJgxr9KGxtvQhTHzY · รอเคาะนโยบาย: รับเคลมกี่วัน · ริบมัดจำ · คืนเงินหรือเครดิต · ค่าของที่ทำทิ้ง
- [ ] **ใบผลิตแบบหน้าออเดอร์ + ระบบปัญหาเดียว** (เบสสั่ง 2026-09-19 "รื้อได้หมด และ refactor") — **รอเบสเคาะต้นแบบรอบ 1** https://claude.ai/artifact/PWomes8NjdSwSNNKjf2mrj · ยังไม่แตะโค้ด · ผลสำรวจ+แผน: สมอง `design-work-order-problems-2026-09-19.md` · ก้อน A (ไม่แตะ schema): ตารางรายรายการ · แตก `work-order-kit.tsx` · ลบชุดซ้ำ · ก้อน B: กล่องปัญหาในการ์ดขั้นแทน 2 dialog → ใบปัญหาเป็นแถวจริง (migration) + คิวปัญหา
