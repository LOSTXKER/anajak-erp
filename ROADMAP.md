...
- [ ] **ใบผลิตโครงเดียว + เชื่อมระบบปัญหาให้ครบ** (เบสสั่ง 2026-09-20) — **รอเบสเคาะต้นแบบ** https://claude.ai/artifact/8biaYgjqfWerV3FCT2Mupm · ขอบเขต: การ์ดขั้นทุกชนิดใช้ตารางชุดเดียว (เบิกเสื้อ/ตรวจรับเลิกเป็นการ์ดซ้อน) · ตัดแท็บสินค้าที่ซ้ำ เหลือ ขั้นตอน/วัตถุดิบ/ประวัติขั้นงาน · กล่องปัญหาเป็นแถบเรื่อง · ประวัติรวมเรื่องปัญหาและเบิกเสื้อ · กดเส้นทางงานดูขั้นอื่นได้ · ไม่แตะ schema/สิทธิ์/สถานะ · ผลตรวจ รูเชื่อมต่อ 7 จุด และก้อนงาน: สมอง `design-work-order-unified-2026-09-20.md` · ยังไม่แตะโค้ดแอป
- ระบบปัญหารอบสอง (`dfb50a3` `6dcc670`) อยู่บน main · migration `20260919183248` ลงฐานจริงแล้ว (`migrate status` 20 ก.ย. = up to date · สำรองที่ `~/Backups/anajak-erp-db/`) · **ยังไม่ทำ**: แนบรูปตอนแจ้ง · QC/ร้านนอก/เคลมยังไม่เปิดใบปัญหาชุดเดียวกัน · ที่มา: สมอง `design-work-order-problems-2026-09-19.md`
