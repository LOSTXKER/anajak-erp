...
- ทำถึงไหน: 2026-09-15 ค่ำ รอบ "โล่งขึ้น" บน branch `nami/orders-calm-20260915` ตามข้อที่เบสเลือกจากหน้าลอง (สมอง `records/projects/anajak-erp/mockup-orders-calm-2026-09-15.html`): รายการ = หัวตารางไม่มีพื้นเทา เส้นแถวจาง · ใบออเดอร์ = ถอดบรรทัดลูกค้า/ผู้ติดต่อ/ชื่องานและป้ายลูกค้าเห็นที่หัว (หัวแนวกลางเดียว) · รางขั้นเต็มแถวกว้างเท่ากัน ขั้นปัจจุบันไม่เป็นแคปซูล · กล่องตัวเลขไม่มีบรรทัดเล็ก/ไซส์ วงนับวันขวา แถบชำระล่าง · ลูกค้าและการจัดส่งเป็นช่องพรีวิว กดไปหน้าลูกค้า/แท็บจัดส่ง · รายละเอียดงานมีหัวข้อทุกช่อง · เอาเส้นเวลาออกจากภาพรวม
- ตรวจแล้ว: typecheck · lint 0 error · test 188 ไฟล์ · verify:ui (ปรับด่านหัวใบ/ราง/ภาพรวมตามข้อใหม่) · เรนเดอร์ชิ้นจริงเป็น HTML นิ่งเปิดดูหัว ราง กล่องตัวเลข พรีวิว รายละเอียดงาน ตรงหน้าลอง · **ยังไม่ได้เปิดหน้าจริงที่ล็อกอิน** (Chrome ของเบสต่อไม่ติด)
- ติดอะไร: ของที่หน้าจริงมีแต่หน้าลองไม่มี คงไว้ใต้พรีวิวลูกค้า = ประวัติซื้อ (เห็นเงินเท่านั้น) และพับข้อมูลออกบิล · เลขพัสดุอยู่บรรทัดเล็กในพรีวิวจัดส่ง · ปุ่มโทร/แชทในภาพรวมหาย (ทำที่หน้าลูกค้า) · รายละเอียดงานของจริงมีแค่ชื่องาน/แบรนด์/สี/ฟอนต์/หมายเหตุสไตล์ (สินค้า/ตำแหน่งพิมพ์อยู่แท็บรายการ) · ข้อ 6 (ป้ายสถานะซ้ำข้างเลข) และ 8 (หมายเหตุกล่องขาว) เบสยังไม่ตอบ จึงไม่ทำ · ค้างจากรอบก่อน: ไม่ลองอัป/ลบไฟล์ · ปุ่มตรวจนับ QC ใบ V2 และ "วางบิลแล้ว" นับซ้ำ แยกงานแล้ว
- ทำต่อ: เบสเปิด `localhost:3000/orders` บน branch นี้ดูของจริง → แก้ตามคำทัก → เบสอนุมัติแล้ว merge ขึ้น main (ห้าม push main เอง) · ตอบข้อ 6/8 และเรื่องปุ่มโทร/LINE ในภาพรวม
