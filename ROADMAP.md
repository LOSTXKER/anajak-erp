...
- [ ] **คำถามที่ต้องเคาะก่อนลงของจริง** (จากรีวิว): (1) กระดาษ 1 ใบต่อใบผลิต หรือ 1 ใบต่อกอง (ออเดอร์ 3 สี ปักแขนไปทั้ง 240 — กองสีเทาที่ไม่ปักเดินด้วยใบไหน) (2) QC เจอเสีย 8 ตัวต้องรีดใหม่ — เขียนบนใบเดิม (ระบบไม่รู้) หรือระบบเปิดขั้นแก้แล้วพิมพ์ใบใหม่ (3) รีดร้อน "จด" หรือ "ไม่จด" ให้ขาด — ไม่เอา "ไม่บังคับ" เพราะข้อมูลครึ่งเดียวทำให้ TV/ตัวชี้วัดเชื่อไม่ได้
- [ ] เคาะแล้ว → ลงของจริง (presentation ก่อน): ใบผลิต StepDetail แยกโหมดจด (screen/paper/auto) + แถบใบกระดาษ/ช่วงงานอนุมาน + ปุ่มพิมพ์ใน PageShell action · ใบสั่งงานกระดาษ route ต่อ production id: ตารางแยกโรงงาน/ร้านนอก · แถวจอไม่มีช่องยอด · ท้ายใบฉบับ/วันพิมพ์ · QR `?ticket=n` · โหมดหน้างานเหลือคิว เบิกเสื้อ/QC/แพ็ก/ร้านนอก · สแกนที่สถานี QC เปิดหน้าลงมือ QC ของใบนั้น
