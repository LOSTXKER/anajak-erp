...
> **ยังไม่เริ่ม — เบสเลือกให้ไปทำ session ใหม่ (context เต็ม)**
...
**2 ทางเลือก — ต้องให้เบสเคาะก่อนลงมือ:**
- **(ก) เล็ก ไม่แตะฐานข้อมูล** — แก้ป้าย "ที่อยู่ (จัดส่ง)" → "ที่อยู่ลูกค้า" ทุกจุด · เพิ่มปุ่ม "ใช้ที่อยู่ลูกค้า" ในฟอร์มที่อยู่จัดส่ง (ทั้งหน้าสร้างและหน้าแก้) · แยกบล็อก "ที่อยู่ลูกค้า / ที่อยู่ออกบิล / ที่อยู่ส่งของ" ให้ชัดทั้ง 4 หน้า
- **(ข) ใหญ่ แตะ schema (ต้องขออนุญาต)** — ตาราง `CustomerAddress` หลายที่อยู่ต่อลูกค้า + เลือกตอนเปิดงาน · แก้ให้ถูกจริงระยะยาว แต่กระทบ migration + หน้าลูกค้า + ใบกำกับภาษี

**บั๊กที่ต้องเก็บในใบงานเดียวกัน:**
- [ ] **popup "แก้ไขข้อมูลลูกค้า" ล้นกรอบ** — เนื้อในสูงเกินกล่อง ปุ่มบันทึกตกนอกจอ (เบสส่งภาพ 2026-08-12) · ตรวจ dialog อื่นที่ยาวด้วย (`order-info-edit-dialog`, `create-invoice-dialog` ฯลฯ)
- [ ] ตรวจบั๊กอื่นทั้งเว็บรอบใหญ่ตามที่เบสสั่ง "ตรวจบั๊กอื่นๆด้วย"
