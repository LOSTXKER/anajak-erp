...
- [ ] หน้าลอง `/proto/paper-first`: ปัจจุบัน / **A จอจด 3 จุด** / B หัวหน้ากรอกจากกระดาษ · สวิตช์ มีร้านนอก/ไม่มี · หัวหน้า/ช่าง · ธีม — **รอเบสเคาะ**
- [ ] เคาะแล้ว → ลงของจริง (presentation ก่อน): ใบผลิต StepDetail แยกโหมดจด (screen/paper/auto) · ใบสั่งงานกระดาษเพิ่มช่อง + QR ชี้ใบผลิต · โหมดหน้างานเหลือคิว QC/แพ็ก/ร้านนอก
- ⚠️ ถามก่อน: "จุดที่ต้องจด" ควรเป็น flag ต่อขั้นใน `RoutingOperation` (สูตรขั้นงาน) ไม่ใช่ hardcode = งาน schema · กฎ "ขั้นที่ไม่จดถือว่าผ่านเมื่อจุดถัดไปจด" ต้องเข้า `transitionOrder`/step service ฝั่ง server · ตัวชี้วัด §C MFG เหลือระดับใบ (ข้อแลกที่เบสรับแล้ว)
