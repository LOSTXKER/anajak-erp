...
- ติดอะไร: แท็บรายการของจริงดูผ่าน CSS + โครงจำลอง ไม่ได้เรนเดอร์คอมโพเนนต์ตรง (ต้องใช้ข้อมูลจากฐาน) · ปุ่มโทร/แชทในภาพรวมหาย (ทำที่หน้าลูกค้า) · รายละเอียดงานของจริงมีแค่ชื่องาน/แบรนด์/สี/ฟอนต์/หมายเหตุสไตล์ · ค้างจากรอบก่อน: ไม่ลองอัป/ลบไฟล์ · ปุ่มตรวจนับ QC ใบ V2 และ "วางบิลแล้ว" นับซ้ำ แยกงานแล้ว
- ทำต่อ: เบสเปิดเว็บจริงหลัง Vercel ขึ้นเสร็จ ไล่ดูใบออเดอร์ทุกแท็บ → แก้ตามคำทัก · ลองบทบาทอื่น (ช่าง/บัญชี) และอัปไฟล์บนที่เก็บทดลอง
