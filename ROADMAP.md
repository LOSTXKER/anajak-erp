...
- ทำต่อ: **ออเดอร์และการผลิต — เบสสั่งทำเป็นต้นแบบก่อน (16 ก.ย.)** ต้นแบบกดเล่นได้ที่ `records/projects/anajak-erp/mockup-orders-production-2026-09-16.html` ในสมอง: ออเดอร์ 5 หน้า (รายการ · ใบเต็ม 7 แท็บ · เปิดงานใหม่ · แก้ไข · แก้ไขรายการ) การผลิต 7 หน้า และกล่องโต้ตอบ 16 กล่อง · **17 ก.ย. เบสสั่งรื้อแท็บรายการเป็นตารางที่ไม่ซ้ำข้อมูล และให้เปิดงานใหม่/แก้ไข/แก้ไขรายการใช้ฟอร์มเดียวกัน 4 แท็บ** ทำแล้ว รอเบสไล่ดู · โค้ดจริงของสองโมดูลยังไม่แตะ (รวมเส้นแดงในหน้าออเดอร์ที่เคยขอคืน)
