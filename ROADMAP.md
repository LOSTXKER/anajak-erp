...
- ทำต่อ: **ฟอร์มออเดอร์ขึ้นเว็บจริงแล้ว (main รวมบั๊กนับไซส์/ชิปสเปค) · รอเบสสั่ง merge บน `nami/order-form-size-spec-20260918`: ไอคอนหัวข้อย่อยในชุดงาน + ปุ่มคัดลอกรายการ** (เบสสั่ง 2026-09-18 แทนช่อง "คัดลอกลาย" เดิม · ชุดใหม่ไปท้ายรายการ ไม่แทรกกลาง เพราะ index เป็นตัวชี้ของหน้า · ล้าง formKey/savedProductId/หลักฐานรับของ) · ยังค้าง: เลขรายการในกล่อง error ไม่ขยับตามเมื่อรายการเปลี่ยน (ของเดิม เกิดกับปุ่มลบด้วย) · ลบชุดงานยังไม่มีถามยืนยัน · โมดูลผลิตไม่แตะ (หน้าใบผลิตยังใช้การ์ดชุดเก่า รอเคาะแยก)
