...
- ทำถึงไหน: 2026-09-14 เบสสั่งรื้อ UX/UI ใหม่แนว minimal modern (Notion/Vercel) มุมโค้ง มีลูกเล่น คงน้ำเงิน Anajak และฟอนต์ Prompt สีอื่นรื้อได้ ทำหน้าแรกเป็นต้นแบบก่อน. ต้นแบบ = ไฟล์ HTML เดี่ยวในสมอง `records/projects/anajak-erp/mockup-home-minimal-2026-09-14.html` (artifact `claude.ai/code/artifact/b29b1705-5303-4d8f-b99d-af7e879d485e`) มีสวิตช์เทียบแบบเดิมและ 4 มุมมอง; โค้ดแอปยังเท่า `7691bf7`. ค่ำวันเดียวกันเบสเคาะทิศ "ใช่เลย" แต่ปัด "ต้องเช็กก่อน" แบบตัวเลขนับว่าใช้จริงไม่ดี → รอบ 2 เปลี่ยนเป็น "ต้องจัดการวันนี้" ออเดอร์เป็นแถวบอกขั้นค้าง/คนที่รอ เงินแยกการ์ด มี 2 แบบในต้นแบบ (ก แยกกลุ่มตามความด่วน / ข ตารางเดียว)
- ตรวจแล้ว: ต้นแบบรอบ 2 เปิดจริงบน 1440 และ 375 ทั้งสว่าง/มืด ไม่ล้นแนวนอน; ก/ข สลับได้ ตัวกรอง กรองตามวัน ⌘K กระดิ่ง และมุมมองไม่เห็นเงิน/ไม่มีเรื่องค้าง/กำลังโหลดทำงาน. รอบนี้ไม่แตะโค้ดแอป จึงไม่มีผล typecheck/test ใหม่
- ติดอะไร: รอเบสเลือก ก หรือ ข; "ต้องจัดการวันนี้" ต้องมี query ใหม่ (ขั้นที่ค้าง ผู้ทำ รอลูกค้า/ร้านนอก วันที่นิ่ง) และ "กำหนดส่ง 7 วัน" ต้องเพิ่ม query เล็กใน analytics ก่อนลงจริง; หน้าลอง `/proto` ในโค้ดถูกลบตั้งแต่ 09-11
