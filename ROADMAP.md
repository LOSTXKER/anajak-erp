...
- [ ] **A16: รอเลือกทิศหน้าแรก minimal modern** — เบสสั่ง 14 ก.ย. ให้ลองแนว Notion/Vercel/SaaS โค้งมนและมี interaction คง accent น้ำเงิน; รอบนี้ปรับจาก feedback ว่ายังดีได้มากกว่านี้: ยกงานที่ต้องตามเป็นจุดเด่น ดึงตารางขึ้น และเกลารายละเอียดการโต้ตอบ; ต่อหน้าจริง/หน้าอื่นหลังรับทิศ
- ทำถึงไหน: `/proto/home-modern` รอบปรับปรุงบน `codex/home-modern-prototype-20260914` (เริ่ม `7691bf7` หลังย้อน); ยกงานที่ต้องตามเป็นจุดเด่นพร้อมภาพเสื้อ สลับ 3 งานได้ ลดความสูงสถิติ ดึงตารางขึ้นและเพิ่มผู้ดูแล จัดปฏิทิน/กิจกรรมเป็นรางด้านข้าง เกลาเมนู/แท็บเลื่อน/ดาว/รายละเอียดและมือถือ ใช้ข้อมูลตัวอย่าง คง Prompt กับ accent น้ำเงินและ CSS เฉพาะหน้า ไม่เปลี่ยนหน้าจริง/API/ฐานข้อมูล
- ตรวจแล้วรอบปรับปรุง: typecheck, lint (0 errors/22 warnings เดิม; ไฟล์หน้าใหม่ 0 warnings), 183 files/1,840 tests และ verify:ui ผ่าน; Browser 1440/390 Light/Dark และ 1024 ไม่ล้นหน้า ตารางจอใหญ่เห็น 4 แถว ลองสลับงาน/เปิดรายละเอียด/กรอง/ติดดาว/ไม่มีรายการ/ปฏิทินวันว่าง/ค้นหา/ล้างผล/⌘K/Escape คืน focus/อ่านแจ้งเตือน/ลิงก์สร้างงาน/เมนูมือถือ/หุบเมนู/เลื่อนตาราง; ภาพ `refined-*.png` และ `refine-verification.json` ใน `.tmp-test/home-modern/` ไม่ใช่ผลธุรกรรมหลายบทบาทหรือ release
- ติดอะไร: รอ feedback หน้าแรกรุ่นปรับปรุง; ต้นแบบจำลองบทบาทเจ้าของ รายการและกิจกรรมไม่ใช่ข้อมูลธุรกิจจริง
- ทำต่อ: รับจุดปรับจากหน้าแรกนี้ก่อนขยาย; ถ้ารับทิศแล้วค่อยต่อข้อมูล/สิทธิ์เดิมและเดิน flow A16 ด้านล่าง
