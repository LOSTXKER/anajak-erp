...
- ทำต่อ: **รอเบสสั่ง merge บน `nami/priority-days-20260918`: ฟอร์มเพิ่มลูกค้าชุดเดียวทั้งเว็บ · ตารางออเดอร์ถอดคอลัมน์ต้องจัดการ** (ตัวเลือกลูกค้าในฟอร์มเปิดงาน/ใบเสนอเรียก `CustomerCreateDialog` ของหน้าลูกค้า แทนฟอร์มย่อ 4 ช่องที่ไม่มีที่อยู่/เลขภาษี · กันซ้ำชื่อ/เบอร์/LINE ย้ายเข้ากล่องกลาง ได้ทุกทางเข้า · กล่องหยุด submit ไม่ให้ทะลุไปสั่งเปิดงาน — ถอด guard แล้วฟอร์มใหญ่ยิงจริง · ตาราง /orders เหลือ 8 คอลัมน์ เหตุที่ต้องจัดการยังอ่านได้ที่แผงดูย่อ/ใบเต็ม/การ์ดจอแคบ) · **รอบถัดไป: ถอดช่องความเร่งด่วนออกจากฟอร์ม ให้สัญญาณด่วนมาจากกำหนดส่ง** (เบสเคาะ 2026-09-18 "ซ้ำกับเวลาส่ง" → commit ช่วงวัน c2751ad ถูกกลบรอบนั้น · แตะ: ป้ายด่วนทุกจุด · ตราแดงใบสั่งงาน · จอ TV · เรียงคิวผลิต/สถานี · verify-print) · ยังค้าง: เลขรายการในกล่อง error ไม่ขยับตามเมื่อรายการเปลี่ยน (ของเดิม) · ลบชุดงานยังไม่มีถามยืนยัน · โมดูลผลิตไม่แตะ (รอเคาะแยก)
