...
- [ ] **งานแก้และเคลมหลังลูกค้ารับของ** (เบสสั่ง 2026-09-18 · อนุญาตให้รื้อถึงราก) — ก้อน 0 ขึ้นเว็บแล้ว (`7a8d5aa`) · **ก้อน 1 (ใบเคลม) เสร็จครบบน branch แล้ว ยังไม่ขึ้นเว็บและยังไม่ลงฐานจริง**: `OrderClaim`/`OrderClaimLine` รายไซซ์ · เปิดอัตโนมัติตอนตีกลับใบส่ง · ปุ่มเดียวสั่งงานแก้ (ถอยทีละขั้นผ่าน transitionOrder) · ปิดใบไม่ได้จนเอกสารเงินออกจริงและยอดตรง · สิทธิ์ `decide_claims` (เจ้าของ/ผู้จัดการ/ฝ่ายขาย) · ไม่เพิ่มแท็บ/การ์ด: แถบบนใบออเดอร์ + เหตุ `claim` ใน home-orders ครบ 4 จอ · หน้าลูกค้าใช้แถบ รับเรื่อง → กำลังแก้งาน → ส่งกลับให้ใหม่ แทนเส้นทางเดิมที่เดินถอยหลังเงียบๆ (คำคิดฝั่ง server ทั้งหมด ไม่มีเงิน/คนผิด/เลขใบ) · ร้านเขียนข้อความถึงลูกค้าเองได้ในกล่องใบเคลม · **ก้อนถัดไป**: ตีกลับบางส่วน (2) · แก้รายการใต้ใบเคลม (3) · งานแก้บนใบผลิต V2 (ต้องขึ้นเหตุผลบนจอ) · คู่มือ 80 เคส: https://claude.ai/artifact/MtyRHyJgxr9KGxtvQhTHzY · **ลงฐานจริงแล้ว 18 ก.ย. 69** (สำรองก่อนที่ `~/Backups/anajak-erp-db/`) **เหลือรอเบสสั่ง merge** · รอเคาะนโยบาย: รับเคลมกี่วัน · ริบมัดจำ · คืนเงินหรือเครดิต · ค่าของที่ทำทิ้ง
