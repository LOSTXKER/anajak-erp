...
- ทำต่อ: **รอเบสสั่ง merge บน `nami/priority-days-20260918`: ปุ่มย้อนกลับบนหัวใบออเดอร์และหัวใบผลิต** (เบสสั่ง 2026-09-18 "เอาปุ่ม CTA ย้อนกลับออกมา จะได้กดได้ง่ายๆ" · หน้าออเดอร์: `singleBackStatus` ยกขาที่ถอยได้ทางเดียวมาเป็นปุ่ม ใช้ด่านสิทธิ์เดิม ถามยืนยันพร้อมบอกผล (QC→ผลิต เปิดขั้นงานแก้ · →ออกแบบ ปลดล็อกแก้ราคา) ส่งแล้ว/ปิดงานยังขอเหตุผล · หน้าผลิต: ยกรายการย้อนขั้นจากเมนู ⋯ เป็นปุ่ม ด่านครบตาม server (ปิดด้วยปุ่ม · ไม่มีหลักฐานผูก · ขั้นถัดไปยังไม่เริ่ม · ออเดอร์กำลังผลิต) ย้อนไม่ได้เหลือรายการจางพร้อมเหตุผล · SPEC บรรทัด 59 แก้ตามกติกาใหม่ · ตรวจอิสระ 3 มุม ยืนยันจริง 4 แก้ครบ) · **ยังไม่ได้เปิดสองหน้าจริง (ต้องล็อกอิน)** · ยังค้าง: ปุ่มย้อนหน้าผลิตยังไม่รู้จัก V2 (V2 ยังไม่เปิดจึงไม่กระทบ) · เลขรายการในกล่อง error ไม่ขยับตาม · ลบชุดงานยังไม่มีถามยืนยัน · `work-order-page.tsx` เป็นเชลล์ของหน้าลองที่ไม่ได้ใช้จริง รอเคาะว่าจะลบ
