...
- [ ] **PC3 รอบพิมพ์ฟิล์ม `/production/print-runs`** — รอบที่เครื่องกำลังพิมพ์อยู่บนสุดเห็นทันที → รอตัดแยก+ติดป้าย → คิวพิมพ์เรียงตามกำหนดส่งพร้อมเลือกเข้ารอบ · desktop วางคิวกับรอบให้เห็นพร้อมกัน เพราะช่างจัดม้วนต้องดูสองอย่างคู่กัน
