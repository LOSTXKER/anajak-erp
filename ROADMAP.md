...
- ทำถึงไหน: 2026-09-15 หน้าออเดอร์อยู่บน branch `nami/orders-mockup-20260914` (ยังไม่ merge main) · ลงจริงรอบแรกแล้วเบสตอบ "ไม่เห็นเหมือนเลย" → วางต้นแบบคู่หน้าจริงแล้วแก้ทีละส่วน: รายการ (หัวตารางพื้นจม คอลัมน์การชำระ ชิปวิธีพิมพ์/วันส่ง ถ้อยคำต้องจัดการตามต้นแบบ แถบเลขหน้า คีย์ลัด / ดูย่อสูงเต็มจอ การ์ดมือถือ) · ใบออเดอร์ (ป้ายเตือนชุดเดียว ชิปหัวใบ แคปซูลขั้นปัจจุบัน ช่องข้อมูลหลักมีขอบ วันที่ย่อ ช่องย่อยมีไอคอน ผู้ติดต่อแถวเดียว การ์ดม็อกอัพ เส้นเวลา) · แท็บรายการ งานผลิต จัดส่ง เงิน & บิล ประวัติ ตามต้นแบบ
- ตรวจแล้ว: typecheck · lint 0 error (22 warning เดิม) · test 188 ไฟล์/1,859 · verify:ui ผ่าน · เปิดต้นแบบคู่หน้าจริงที่ 1512px ครบรายการ ดูย่อ ใบออเดอร์ทุกแท็บ · โหมดมืด · จอ 375 จากภาพหน้าจริงแบบนิ่ง (แก้การ์ดมือถือล้นกล่องแล้ว) · console ไม่มี error
- ติดอะไร: แท็บม็อกอัพ & ไฟล์ยังเป็นหน้าตาเดิม (ส่วนกลางที่หน้าผลิตใช้ร่วม มีอัป/อนุมัติ ต้องทำแยกรอบ) · หัวตารางพื้นจมเป็นข้อยกเว้นเฉพาะหน้าออเดอร์ · ชิปตัวกรองความเร่งด่วนเปลี่ยนจากเส้นใต้เป็นชิปฟ้าตามต้นแบบ (แก้สัญญาใน brand-selection.test) · ฐานทดลองไม่มีประวัติเปลี่ยนสถานะ แคปซูลจึงโชว์ขั้นใบผลิตแทนจำนวนวัน · มือถือยังไม่ได้ลองบนเครื่องจริง
- ทำต่อ: เบสเปิด `localhost:3000/orders` เทียบต้นแบบอีกรอบ → แก้ตามคำทัก → ทำแท็บม็อกอัพ & ไฟล์ให้ตรงต้นแบบ → merge/ปล่อยตามอนุมัติ (ห้าม push main เอง)
