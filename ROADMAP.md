...
- **ตรวจแล้ว:** 2026-09-11 typecheck/test 1,823/verify:ui ผ่าน; lint 0 errors, 23 warnings; ลิงก์/ตัวอ่าน ROADMAP ผ่าน (ขอบเขตด้านล่าง); เพิ่มกฎ ui-guidance แล้ว ตรวจลิงก์/ขนาด DESIGN ผ่าน รอบนี้แก้เอกสาร ไม่มีผลลอง UI ใหม่
