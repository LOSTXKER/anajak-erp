...
- [x] **กล่องแจ้งเตือน (Alert) ทั้งเว็บ** — เบสทัก 09-03 (รูปการ์ดปัญหาในใบผลิตธีมมืด) "ดูโง่ไป และเป็นทั้งเว็บ ปัญหาเดิม": 49 ไฟล์ 72 จุด มีไอคอนแค่ 12 · meta เป็นบรรทัดจุด · ปุ่มยัดในข้อความ → หน้าลอง `/proto/alert` (ปัจจุบัน / **A ตราไอคอน + ชั้นข้อความ** บนพื้นสี / **B แถบสีข้าง พื้นเรียบ** · ทั้งคู่ไอคอนอัตโนมัติ + ช่อง meta เป็นชิป + ช่องปุ่ม · ตัวอย่าง 6 จุดจริง) — **รอเบสเคาะ** · ลงจริง = แก้ `ui/alert.tsx` ไฟล์เดียว (เพิ่ม prop `meta`/`action` · ไอคอนตามชนิด) แล้วย้าย meta/ปุ่มของจุดที่มี (ใบผลิต ProblemCard · ข้อมูลค้าง · ส่งเข้า QC) มาใส่ช่องใหม่ — refactor ของเก่าให้ผ่านกฎ 3 ชั้น (เบสสั่ง 2026-09-02 "แก้ราก + refactor ด้วย")
