...
- [ ] **งานแก้และเคลมหลังลูกค้ารับของ — ก้อน 0** (เบสสั่งทำ 2026-09-18 หลังถามว่าจะรับมือยังไงเมื่อส่งของแล้วลูกค้าขอแก้ · อนุญาตให้รื้อถึงราก) — ขอบเขตก้อน 0 = ปิดรูที่เป็นบั๊กอยู่แล้ว ไม่แตะฐานข้อมูล ไม่เปลี่ยนกฎเงิน/สิทธิ์: (1) ปุ่มเปิดใบส่งรอบใหม่ตอนปิดงาน (UI ซ่อนแต่ server ยอมอยู่แล้ว) (2) ตีกลับใบส่งต้องมีเหตุผลและลงประวัติออเดอร์ (3) ถอย "จัดส่งแล้ว → ตรวจสอบคุณภาพ" ต้องบอกว่าต้องถอยต่อถึงกำลังผลิต งานผลิตจึงเปิดจริง (4) สำเนาออเดอร์ทิ้ง blindShip (ลูกค้ารีเซลเลอร์ตัวตนร้านหลุด) (5) เก็บรายการเต็มลง OrderRevision (วันนี้ลบแล้วสร้างใหม่ ประวัติรายการหายถาวร) · ก้อน 1-4 ต้อง migration รอเคาะทีละก้อน: ใบเคลม · ใบส่งผูกรายการจริง · แก้รายการใต้ใบเคลม+บังคับใบลดหนี้/เพิ่มหนี้ · เส้นเชื่อมออเดอร์ · คู่มือ 80 เคส/9 วิธีจัดการ: https://claude.ai/artifact/MtyRHyJgxr9KGxtvQhTHzY · รอเบสเคาะนโยบาย 5 ข้อ (รับเคลมกี่วัน · ยกเลิกแล้วริบอะไร · คืนเงินหรือเครดิต · ใครมีอำนาจให้ฟรี/ลด · ค่าของที่ทำทิ้งคิดใคร)
