...
### รอเลือกต้นแบบ: รายละเอียดออเดอร์และหน้าแรก

- คำขอล่าสุด 13 ก.ย. 2569: เบสยังไม่รับหน้าตารอบล่าสุด ขอรื้อองค์ประกอบโดยคงโครงใกล้เดิม. หน้าลอง `/proto/order-workspace` พร้อมให้เลือก โดยยังไม่เปลี่ยนหน้าจริงในรอบนี้
...
- ทดลองได้: ยกเลิก/บันทึกข้อมูลและที่อยู่ เปิดข้อมูลติดต่อ/ภาพ/เงิน/รายการ สลับกรณีมี–ไม่มีม็อกอัพหรือขาดไฟล์พิมพ์ และเพิ่มไฟล์ตัวอย่าง. ทุกการแก้เป็นสถานะชั่วคราวในหน้าลอง ไม่มีการบันทึกฐานหรือส่งข้อความ; ใช้ noindex จาก layout เดิม ไม่แก้ auth/สิทธิ์/API/สูตรเงิน/สถานะ/V2
- ตรวจหน้าที่เรนเดอร์จริง: 1440/390 ทั้ง Light/Dark ไม่มีหน้าล้น รูปโหลดครบ Prompt เดิม; ลองตัวกรอง/ค้นหาไม่พบและล้าง กลับจากหน้าแรกเข้าออเดอร์ ยกเลิก/บันทึก/เทียบโครง เติมม็อกอัพและไฟล์พิมพ์ ป้ายปัญหาหายเมื่อมีไฟล์ และเปิดภาพ/แท็บรายการ/เงิน. ตรวจ React และคำบนจอตาม ui-guidance แล้ว
- ด่านตรวจ: typecheck ผ่าน; lint 0 errors/22 warnings เดิม; 201 files/1,971 tests ผ่าน; verify:ui 255 + work-order 32 ผ่าน. Log `proto-workspace-*` อยู่ `.tmp-test/ui-polish-20260913/` ไม่เข้า Git. สคริปต์ proto-shots เดิมไม่พบทั้งต้นฉบับและสำเนาติดตั้ง จึงตรวจภาพผ่าน browser โดยไม่ได้อ้างผลผ่านสคริปต์เก่า
- จุดต่อ: ให้เบสเลือก/ปรับต้นแบบก่อนนำไปใช้กับหน้าออเดอร์และหน้าแรกจริง. งานนี้อยู่ branch `codex/ui-focus-two-pages-20260913` ยังไม่ใช่ main/Production
