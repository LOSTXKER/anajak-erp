...
- ทำต่อ: **ปุ่มย้อนกลับบนหัวใบออเดอร์และหัวใบผลิต + ฟอร์มลูกค้าเพิ่ม/แก้ไขหน้าตาชุดเดียวกัน ขึ้นเว็บจริงแล้ว (เบสสั่ง merge 2026-09-18)** (เบสสั่ง 2026-09-18 "เอาปุ่ม CTA ย้อนกลับออกมา จะได้กดได้ง่ายๆ" · หน้าออเดอร์: `singleBackStatus` ยกขาที่ถอยได้ทางเดียวมาเป็นปุ่ม ถามยืนยันพร้อมบอกผล ส่งแล้ว/ปิดงานยังขอเหตุผล · หน้าผลิต: ยกรายการย้อนขั้นจากเมนู ⋯ เป็นปุ่ม ด่านครบตาม server ย้อนไม่ได้เหลือรายการจางพร้อมเหตุผล · SPEC บรรทัด 59 แก้ตามกติกาใหม่ · ตรวจอิสระยืนยันจริง 4 แก้ครบ) · **ยังไม่ได้เปิดสองหน้าจริง (ต้องล็อกอิน)** · ยังค้าง: ปุ่มย้อนหน้าผลิตยังไม่รู้จัก V2 (V2 ยังไม่เปิดจึงไม่กระทบ) · เลขรายการในกล่อง error ไม่ขยับตาม · ลบชุดงานยังไม่มีถามยืนยัน · `work-order-page.tsx` เป็นเชลล์ของหน้าลองที่ไม่ได้ใช้จริง รอเคาะว่าจะลบ · ฟอร์มลูกค้า: ปุ่มประเภทพอดีเนื้อหาทั้งสองฟอร์มและแจ้งช่องไม่ครบหลังกดครั้งแรกทั้งคู่ (ต่างกันเฉพาะกลุ่มลูกค้า/กันซ้ำ/คำบนปุ่มที่คนละงาน)
