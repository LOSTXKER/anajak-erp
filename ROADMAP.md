...
- ทำต่อ: **รอเบสสั่ง merge บน `nami/priority-days-20260918`: ฟอร์มเพิ่มลูกค้าชุดเดียวทั้งเว็บ · ตาราง /orders ถอดคอลัมน์ต้องจัดการ · ช่องความเร่งด่วน → "ลำดับคิวผลิต"** (เพิ่มลูกค้า: ตัวเลือกลูกค้าเรียก `CustomerCreateDialog` ของหน้าลูกค้า เลิกใช้ฟอร์มย่อ 4 ช่องที่ไม่มีที่อยู่/เลขภาษี · กันซ้ำและกัน submit ทะลุฟอร์มแม่อยู่ในกล่องกลางแล้ว · ลำดับคิว: เบสถามว่าซ้ำกับกำหนดส่งไหม → เคาะไม่ถอด (คันโยกเดียวที่บอกว่าใบไหนก่อนเมื่อส่งวันเดียวกัน · ถอดต้องรื้อโซนผลิต/จอ TV/ใบสั่งงาน/การเรียงคิว + test 8 ไฟล์) แก้ต้นเหตุแทน: เอาช่วงวันออกจากป้าย (กลบ c2751ad) · เลิกเดาระดับจากกำหนดส่ง · ตั้งชื่อช่องใหม่ + คำช่วย) · ป้ายลำดับคิวทุกจุดใช้คำชุดเดียวกับตัวเลือกแล้ว (เบสสั่ง 2026-09-18 ใช้ "สูง") · ยังค้าง: เลขรายการในกล่อง error ไม่ขยับตาม · ลบชุดงานยังไม่มีถามยืนยัน · โมดูลผลิตไม่แตะ
