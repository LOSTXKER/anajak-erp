...
- ทำต่อ: **ออเดอร์ — ลงโค้ดจริงตามต้นแบบแล้ว รอเบสไล่ดูก่อน merge** ต้นแบบที่เคาะ `records/projects/anajak-erp/mockup-order-form-2026-09-18.html` ในสมอง (ไล่ปรับกับเบส 7 รอบ) · branch `nami/order-form-kit-20260918`: การ์ดลูกค้า (ยุบช่องค้นหาเมื่อเลือกแล้ว · วงเงินเป็นชิป) · รับเรื่องสองฝั่ง · แถวลูกค้าส่งมา/ตัดเย็บใหม่อ่านเหมือนแถวสต็อก · สรุปยอดเป็นการ์ดติดขอบขวา · ขึ้น main ไปแล้ว: แท็บรายการของใบออเดอร์ · โมดูลผลิตไม่แตะ (หน้าใบผลิตยังใช้การ์ดชุดเก่า รอเคาะแยก)
