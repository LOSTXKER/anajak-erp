...
- [ ] **ใบผลิตแบบหน้าออเดอร์ + ระบบปัญหาเดียว** (เบสสั่ง 2026-09-19 · เคาะต้นแบบ 09-20) — **ทำครบแล้วบน branch `nami/work-order-problems-20260919` รอเบสสั่งขึ้นเว็บ** · การ์ดขั้น+แท็บสินค้าเป็นตารางรายรายการ ลายกรองตามขั้น ตัววาดร่วมกับหน้าออเดอร์ที่ `components/order-items` · แผ่นแจ้งและกล่องตัดสินอยู่ในการ์ดขั้น ใช้ชิ้นเดียวกับจอช่าง `/production/floor` · ใบปัญหาเป็นแถวจริงใน `production_exceptions` (คนแจ้ง/เวลา/ของเสียรายไซซ์/หยุดขั้นหรือไม่/รับเรื่อง/คำตัดสิน) แจ้งแบบไม่หยุดทั้งขั้นและหลายเรื่องต่อขั้นได้ · คิวปัญหา `/production/problems` · ตัวอ่าน "ขั้นมีปัญหา" รวมที่ `lib/production-problem` · ที่มา: สมอง `design-work-order-problems-2026-09-19.md`
- **ก่อน merge ต้องลง migration ฐานจริงก่อน**: `20260919183248_add_production_problem_rows` (additive ล้วน · ลงฐานทดลองแล้ว) สำรองฐานก่อนตามขั้นตอนเดิม · **ยังไม่ทำ**: ทีวีโรงงานโชว์เฉพาะเรื่องที่หยุดสายจริง · แนบรูปตอนแจ้ง (มีช่องในฐาน ยังไม่มีปุ่ม) · QC/ร้านนอก/เคลมยังไม่เปิดใบปัญหาชุดเดียวกัน
...
**ขอบเขตรอบ refactor ชุดกลาง (เบสอนุมัติ 2026-09-15):** ย้ายชิ้นส่วนที่เคาะแล้วขึ้น `components/kit` โดยหน้าตาไม่เปลี่ยน · ลบไฟล์ไม่มีผู้ใช้ · หน้าอื่นย้ายทีละหน้าหลังเบสเคาะหน้าลองของหน้านั้น ไม่ย้ายเงียบ · ไม่รวม schema/สิทธิ์/สูตรเงิน/สถานะ
