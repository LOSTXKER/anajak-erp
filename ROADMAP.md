...
- เก็บตามภาพล่าสุด: แท็บออเดอร์เป็นข้อความกับเส้นใต้สีน้ำเงิน ใช้ส่วนกลางเดิม ถอดพื้นเม็ด/ไอคอน/กรอบแท็บ. ป้ายสต๊อก ส่งไม่ระบุผู้ส่ง หมายเหตุ และแจ้งสิทธิ์เงิน อยู่เหนือหัวออเดอร์ครบ; เงื่อนไขและปุ่มแก้ไขเดิม คำช่วยขั้นงานยังอยู่ข้างสถานะ
...
- ตรวจ browser รอบนี้บน demo: ม็อกอัพว่าง 1440/390 ทั้ง Light/Dark ไม่มีหน้าล้น; กด Enter ที่ปุ่มแล้วเปิดแท็บไฟล์จริง URL `?tab=files` และกลับภาพรวมได้. ใบที่มีรูปจริงยังแสดงภาพ สถานะอนุมัติ เวอร์ชัน/วัน และเปิด–ปิดรูปขยายได้. คืนธีมสว่าง/ขนาดจอเดิม/ใบสอบถามหลังตรวจ; แท็บเส้นใต้และป้ายบนสุดที่ตรวจรอบก่อนคงเดิม
- ด่านตรวจ: typecheck ผ่าน; lint 0 errors/23 warnings; 201 files/1,969 tests ผ่าน; verify:ui 255 + work-order 32 ผ่าน. ทบทวน diff และกรณี loading/error/ไฟล์พิมพ์อย่างเดียว/ไม่มี callback; คง query สิทธิ์ ข้อมูลลูกค้า และปลายทางปุ่ม. Log `artwork-*` อยู่ `.tmp-test/ui-polish-20260913/` ไม่เข้า Git
