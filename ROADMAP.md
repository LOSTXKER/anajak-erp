...
> Regression จากก้อนสีล่าสุด: `.card-surface`, status rail และ field/control กลับมามีเส้นรอบ ทั้งที่มติระดับ 3 (`dc40932`, `dbbba71`) ให้ใช้สีพื้น+ระยะ+เงาแทนเส้น · แก้ที่ primitive กลาง ไม่ไล่ปิดขอบรายหน้า

- [x] **M1 พื้นผิวหลักไร้เส้นรอบ** — card/table/list ใช้สีพื้น+เงา · status rail วางราบกับหน้า · overlay ใช้เงาแยกชั้น · ห้าม ring ปลอมเป็น border กลับมา
- [x] **M2 control อ่านออกโดยไม่ตีกรอบ** — field/search ใช้พื้นตามบริบท · secondary button/filter chip ใช้พื้นจม · คงขอบเฉพาะ focus/error, ขอบประพื้นที่เพิ่มไฟล์/รายการ และเส้นคั่นที่จำเป็นต่อการอ่าน
