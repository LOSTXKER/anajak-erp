...
- ทำต่อ: **ฟอร์มออเดอร์ขึ้นเว็บจริงแล้ว รอเบสไล่ดูหน้าจริง** · ค้างเบสเคาะ 3 ข้อ: บั๊กนับไซส์ (ข้อติดอะไร) · ชิปสเปคตัดเย็บโชว์แค่ค่าตามต้นแบบ (06 ก.ย. เคยทักว่าค่าโดดอ่านไม่รู้เรื่อง) · เส้นนำซ้ายใต้แถวไซส์กลับมาตามต้นแบบ (16 ก.ย. เคยสั่งเอาแถบซ้ายออก) · โมดูลผลิตไม่แตะ (หน้าใบผลิตยังใช้การ์ดชุดเก่า รอเคาะแยก)
