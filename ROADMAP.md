...
- ทำถึงไหน: main = `172f9b3` · **2026-09-16 เบสเคาะต้นแบบทุกหน้า (artifact `AZLiV7D1BKg1XUHLXYnAsd`) แล้วสั่ง "ทำจริงเลย ทั้งหมด ยกเว้นออเดอร์และการผลิตทั้งหมด" · ทักซ้ำว่า "ทำไม่เห็นเหมือน proto เลย" จึงไล่เทียบหน้าจริงกับต้นแบบทีละส่วน** → branch `nami/ui-pages-20260916` ทำแล้ว: ① ตั้งค่ามีเมนูข้างทุกหน้าย่อย ② ธีมมืดชุดกลางเป็นเทาล้วน ③ เส้นสีขอบซ้ายแถว (บิล/ใบเสนอราคา/ลูกหนี้/หัก ณ ที่จ่าย) ④ ปฏิทินกรองวันชุดเดียวกับออเดอร์ (บิล ใบวางบิล ใบเสนอราคา ประวัติระบบ ลูกค้า) + router รับ from/to ⑤ สินค้าเป็นตารางแทนการ์ดรูป ⑥ **จัดหน้าตามต้นแบบ**: ลูกค้า (สรุปใต้ชื่อหน้าแทนช่องตัวเลข · ปุ่มกรองเป็นแถบ · คอลัมน์สั่งล่าสุด) · ใบเสนอราคา (ลูกค้า/งาน · หมดอายุ · คนทำ) · บิล (ลูกค้า/ออเดอร์ · ค้างชำระ) · ลูกหนี้/ใบวางบิล/ภาษีขาย (บรรทัดบอกหน้าที่ + ปุ่มกรองแถบ) · รายงาน (ช่องตัวเลข 4 ช่อง + กราฟแท่งตั้ง) · แจ้งเตือน (จำนวนใต้ชื่อหน้า + แถบปุ่มมีจำนวน)
