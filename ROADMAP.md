...
- [ ] **งานแก้และเคลมหลังลูกค้ารับของ** (เบสสั่ง 2026-09-18 · อนุญาตให้รื้อถึงราก) — **ก้อน 0-1 ขึ้นเว็บแล้ว** (`a778707` · ลงฐานจริง 18 ก.ย. สำรองที่ `~/Backups/anajak-erp-db/`) · ใช้ได้จริง: เปิดใบอัตโนมัติตอนตีกลับ · กรอกจำนวนที่เสียรายไซซ์ · แนบรูปในใบของรอบนั้น · ปุ่มเดียวสั่งงานแก้ (ถอยผ่าน transitionOrder) · ปิดใบไม่ได้จนเอกสารเงินตรง · สิทธิ์ `decide_claims` · เหตุ `claim` ครบ 4 จอ · หน้าลูกค้าใช้แถบ รับเรื่อง → กำลังแก้งาน → ส่งกลับให้ใหม่ (ไม่มีเงิน/คนผิด/รูป) · **เทสบนเว็บจริง 2 รอบ (19 ก.ย.)** เจอ 3 รูและแก้หมด: ปุ่มสั่งงานแก้ตายตอน "จัดส่งแล้ว" · หน้าแรก/ตารางไม่ขึ้นเหตุ · ปุ่ม disabled ทึบเหมือนกดได้ (แก้ทั้งเว็บ + ด่าน verify:ui เช็คปุ่มหลักด้วย) · ฐานทดลองมีฉากงานแก้ 2 ใบ (`1eb416e` ยังไม่ merge) · หน้าลอง: https://claude.ai/artifact/8iwpbDWGCKUHbqKzcavaUu · **ยังไม่มีใครใช้กับงานจริงสักใบ** · **ก้อนถัดไป**: ตีกลับบางส่วน (2) · แก้รายการใต้ใบเคลม (3) · งานแก้บนใบผลิต V2 · คู่มือ 80 เคส: https://claude.ai/artifact/MtyRHyJgxr9KGxtvQhTHzY · รอเคาะนโยบาย: รับเคลมกี่วัน · ริบมัดจำ · คืนเงินหรือเครดิต · ค่าของที่ทำทิ้ง
