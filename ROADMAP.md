...
- ทำถึงไหน: 2026-09-14 เบสสั่งรื้อ UX/UI แนว minimal modern (Notion/Vercel) มุมโค้ง มีลูกเล่น คงน้ำเงิน Anajak และฟอนต์ Prompt; ทำหน้าแรกเป็นต้นแบบก่อน. ต้นแบบ = HTML เดี่ยวในสมอง `records/projects/anajak-erp/mockup-home-minimal-2026-09-14.html` (artifact `b29b1705`) มีสวิตช์เทียบแบบเดิม 4 มุมมอง; โค้ดแอปยังเท่า `7691bf7`. เบสเคาะทิศแล้ว; การ์ดซ้ายบนรอบ 4 = แถวสุขภาพ 4 ช่อง + ผังรางตรง 2 สาย (เสื้อ: ออกแบบ→เตรียมเสื้อ→ร้านนอก · ฟิล์ม: พิมพ์ฟิล์ม DTF) บรรจบก่อนรีดร้อน → QC → แพ็ก → ส่ง; node จริงจาก `factory-station.ts`/`production-steps.ts` มีจุดสถานะ แถบงานในมือ/กำลัง คอขวด; รายการต้องจัดการเป็นคอลัมน์ในตารางออเดอร์
