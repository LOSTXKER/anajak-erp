...
- ทำถึงไหน: 2026-09-14 เบสสั่งรื้อ UX/UI ใหม่แนว minimal modern (Notion/Vercel) มุมโค้ง มีลูกเล่น คงน้ำเงิน Anajak และฟอนต์ Prompt สีอื่นรื้อได้ ทำหน้าแรกเป็นต้นแบบก่อน. ต้นแบบ = ไฟล์ HTML เดี่ยวในสมอง `records/projects/anajak-erp/mockup-home-minimal-2026-09-14.html` (artifact `claude.ai/code/artifact/b29b1705-5303-4d8f-b99d-af7e879d485e`) มีสวิตช์เทียบแบบเดิมและ 4 มุมมอง; โค้ดแอปยังเท่า `7691bf7`
- ตรวจแล้ว: ต้นแบบเปิดจริงบน 1440 และ 375 ทั้งสว่าง/มืด ไม่มี console error ไม่ล้นแนวนอน; ค้นหา ⌘K ตัวกรอง กรองตามวัน กระดิ่ง หุบเมนู และมุมมองไม่เห็นเงิน/ไม่มีเรื่องค้าง/กำลังโหลดทำงาน. รอบนี้ไม่แตะโค้ดแอป จึงไม่มีผล typecheck/test ใหม่
- ติดอะไร: รอเบสเคาะต้นแบบหน้าแรก; "กำหนดส่ง 7 วัน" และ "อยู่ร้านนอก" ในการ์ดวันนี้ต้องเพิ่ม query เล็กใน analytics ก่อนลงจริง; หน้าลอง `/proto` ในโค้ดถูกลบตั้งแต่ 09-11
