...
- [ ] **A16: รอเลือกทิศหน้าแรก minimal modern** — เบสสั่ง 14 ก.ย. ให้ลองแนว Notion/Vercel/SaaS โค้งมนและมี interaction คง accent น้ำเงิน; ต่อหน้าจริง/หน้าอื่นหลังรับ feedback
- ทำถึงไหน: มี `/proto/home-modern` บน `codex/home-modern-prototype-20260914` เริ่มจาก `7691bf7` (ไฟล์ตรง `222cac8` หลังย้อน); ต้นแบบ 1 ทิศ มีเมนูใหม่ โฟกัสวันนี้ ปฏิทินส่งงาน ตารางออเดอร์ และรายละเอียดด้านข้าง ใช้ข้อมูลตัวอย่างที่ระบุชัด คง Prompt และแยก CSS เฉพาะหน้า ไม่เปลี่ยนหน้าจริง/API/ฐานข้อมูล
- ตรวจแล้ว: typecheck, lint (0 errors/22 warnings เดิม; ไฟล์ใหม่ 0 warnings), 183 files/1,840 tests และ verify:ui ผ่าน; Browser บน 1440/390 Light/Dark ไม่ล้นหน้า ลองกรอง/ติดดาว/ไม่มีรายการ/เลือกวัน/ค้นหา/ไม่พบผล/⌘K/รายละเอียด/Escape คืน focus/อ่านแจ้งเตือน/หุบเมนู/ปุ่มเลื่อนตารางมือถือ; ภาพและบันทึก `.tmp-test/home-modern/` ไม่ได้ตรวจธุรกรรมหลายบทบาทหรือ release
- ติดอะไร: รอ feedback ทิศหน้าแรก; ต้นแบบจำลองบทบาทเจ้าของ รายการและกิจกรรมไม่ใช่ข้อมูลธุรกิจจริง
