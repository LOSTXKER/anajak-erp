...
- จุดต่อ: รอเบสเทียบรอบ 1 กับรอบ 3 แล้วชี้จุดที่ยังรก/ใช้ยากเป็นจุด ๆ ก่อนทำรอบถัดไป; ห้ามเพิ่มปุ่ม/การ์ด/แถบใหม่. ต้นแบบ React เดิมใต้ `/proto/order-workspace` ยังอยู่เป็นตัวเทียบ. งานอยู่ branch `codex/ui-focus-two-pages-20260913` ยังไม่ใช่ main/Production
