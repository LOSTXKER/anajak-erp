...
- ทำต่อ: **รอเบสสั่ง merge บน `nami/priority-days-20260918`: ความเร่งด่วนบอกช่วงวัน · ตารางออเดอร์ถอดคอลัมน์ต้องจัดการ** (เร่งด่วน ภายใน 1 วัน · สูง 2-3 · ปกติ 3-7 · ต่ำ 7-14 เก็บที่ `PRIORITY_DAY_HINTS` ที่เดียว · โผล่ในช่องเลือก ภาพรวมออเดอร์ ใบสั่งงาน ป้ายหัวใบผลิต · ป้ายเตือนในตาราง/การ์ดยังสั้นคำเดียว เพราะแถวมีวันกำหนดส่งแล้ว · `priorityFromDeadlineDays` เลื่อนเส้นเดาระดับตามนิยามใหม่ เดิม ≤3 วันขึ้นเร่งด่วน) · ตาราง `/orders` เหลือ 8 คอลัมน์ เหตุที่ต้องจัดการยังอยู่ในแผงดูย่อ/ใบเต็ม/การ์ดจอแคบ ตรวจนอก Next col/th/td = 8 เท่ากันทั้งเห็นเงิน/ไม่เห็นเงิน · ยังค้าง: เลขรายการในกล่อง error ไม่ขยับตามเมื่อรายการเปลี่ยน (ของเดิม เกิดกับปุ่มลบด้วย) · ลบชุดงานยังไม่มีถามยืนยัน · ป้ายระดับ HIGH เขียนไม่ตรงกัน (ช่องเลือก "สูง" · ชิป/การ์ด "สำคัญ") รอเบสเคาะคำที่ใช้ · โมดูลผลิตไม่แตะ (หน้าใบผลิตยังใช้การ์ดชุดเก่า รอเคาะแยก)
