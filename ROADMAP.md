...
- [ ] **หน้าลอง `/proto/work-order` ทำแล้ว (09-03 · branch `proto/work-order-2026-09-02`) รอเบสเคาะ** — **D แท็บ + 2 คอลัมน์ (เบสสั่งเพิ่ม 09-03 ตั้งเป็นค่าเริ่มต้น)** / A ตารางขั้นงาน / B ตอนนี้ทำอะไร / C ไทม์ไลน์ · ทุกทาง: หัวใบตัวเลข 4 ช่อง + ปัญหาเป็นการ์ดแดง + โซนลงมือมาตรฐานเดียวกันทุกขั้น (ข้อกำหนดจากสูตร → ปุ่มเดียว) + สวิตช์จอทัช · ไม่เอาผังสายพาน/จอสถานี/แท็บกลับมา · ห้ามยึดกับ 20+ แบบที่ลบไป (commit `ab7d4f8`–`19aeadb`)
- [ ] เคาะแล้ว → ลงของจริง: route `/production/[id]` ใหม่ต่อ `production.getById`/`manufacturing.workOrder` เดิม · checklist ต่อขั้นต้องเพิ่มในสูตรขั้นงาน (`/settings/routings`) แล้วสำเนาลงใบ · dialog เบิก/รอบพิมพ์/QC ออกแบบหลังเคาะโครง
