...
## NEXT
0. **เบสซ้อมจริงบน dev (branch `proto/desk-station-2026-09-03` · `localhost:3000`)**: บัญชีตัวเอง → การผลิต → เปิดใบ → กด "แก้ให้" / "แจ้งปัญหา" ในใบผลิต · ปุ่ม "โหมดหน้างาน" → แผงสถานี → "โต๊ะงาน" กลับ · แล้วสร้าง/ใช้บัญชี PRODUCTION_STAFF ล็อกอินดูว่าตกที่หน้างานและเปิดใบแล้วเห็นหน้าลงมือ → บอกจุดไม่ตรง → build → merge main (เบสสั่ง)
1. หลังเคาะ: ทางกลับจากหน้างานไป My Tasks/แจ้งเตือนของช่าง (ถามเบสว่าจำเป็นไหม) · หน้าลงมือ QC/แพ็ก บนหน้างาน (§A2) · reopen ขั้นที่ปิดแล้ว (server — ถามก่อน)
2. ทางเข้ารอบพิมพ์/คลังฟิล์ม · มือถือหน้าการผลิตเป็นการ์ด (§A3) · ซ้อม V2 ต่อเมื่อหน้างานใช้ได้ (§B) · ว่างค่อย MFG1-3 (§C)
