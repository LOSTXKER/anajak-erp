...
## ตอนนี้
- **Phase: P1 · เสร็จแล้ว: P1.0 Design System ✅ · PDF/ใบกำกับภาษีเต็มรูป ✅ · Job Ticket+QR ✅** (2026-06-10)
- งานถัดไป (เลือกจากลิสต์ P1 ใน ROADMAP): แนะนำ **มัดจำตาม payment terms + overdue cron** (โซ่การเงิน B2B ต่อจากบิล/ใบกำกับที่เพิ่งเสร็จ) หรือ **task queue "งานของฉันวันนี้"** (หน้า ops mobile-first ตัวแรก) หรือ **ใบวางบิล + ลูกหนี้ aging + เช็ค credit limit**
- **เบสต้องทำก่อนใช้เอกสารจริง**: ไปกรอก **Settings → ข้อมูลกิจการ** (ชื่อ/ที่อยู่/เลขผู้เสียภาษี 13 หลัก) — ไม่งั้นหัวเอกสารขึ้น "(ยังไม่ตั้งค่าข้อมูลกิจการ)" · deploy จริงต้องตั้ง `NEXT_PUBLIC_APP_URL` (QR บน Job Ticket ชี้ตามนี้)
