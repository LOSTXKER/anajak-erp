...
## NEXT
1. **ลงของจริง `/production` ใหม่ตามแบบ A** (ROADMAP §A3) — เปิดใบงานย่อยก่อนทำ: route + ตัวเลข 4 ช่อง + ตาราง 8 คอลัมน์ + กอง ต่อ server เดิม · คืนเมนู/ปุ่มเปิดใบผลิต/ลิงก์ · โหมดหน้างานทำต่อเป็นขั้นที่สอง (§A2) (branch `proto/production-module-2026-09-02` · เปิด dev แล้วดูที่ `localhost:3000/proto/production-module`) — A โต๊ะงานหัวหน้า / B สายพาน / C ตารางเวลา · แต่ละทางมีสวิตช์ "โหมดหน้างาน" + "งานล้น" + ธีม · เคาะแล้ว → ลงของจริง (ROADMAP §A2/§A3)
