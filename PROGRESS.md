...
## ตอนนี้ (2026-09-03)
- **หน้าลอง `/proto/action-zone` "โซนลงมือ ปุ่มเยอะ อัดกัน" — รอเบสเคาะ** (branch `proto/action-zone-2026-09-03` · เบสส่งรูป CTA 4 ปุ่มเท่ากัน): ปัจจุบัน / A หนึ่งปุ่มหลัก + เมนูรวม / B ปุ่มหลักขึ้นหัวการ์ด · 4 สถานะ · หัวหน้า/ช่าง · ธีม · ด่านผ่าน · เปิดดูเองสว่าง/มืด · ไม่แตะของจริง (ROADMAP §E2)
...
## NEXT
0. **เบสเปิด `localhost:3000/proto/action-zone` แล้วตอบ A / B** → ลง ActionZone กลาง + ใบผลิต + หน้างาน
