...
1. เบสไล่ดูใบตัวอย่าง 10 สถานะที่ http://localhost:3000/production (ชื่อลูกค้าขึ้นต้น “ฟอร์ม N ·”) หรือ `/production/demo-production-form-<key>` · ถ้าจะให้ฟอร์มขับใบ V2 ด้วย = ROADMAP §B (ยังไม่ได้เคาะ)
