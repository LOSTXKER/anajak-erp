...
## NEXT
0. **เบสดูใบผลิตจริง/หน้าอื่นบน dev ว่ากล่องแจ้งเตือนแบบใหม่โอเคไหม** (branch `proto/desk-station-2026-09-03`) → สั่ง build + push main (มีทั้งโครงใหม่ + Alert B ในก้อนเดียว)
