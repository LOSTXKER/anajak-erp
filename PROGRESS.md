...
## NEXT
0. **เบสเปิด `localhost:3000/proto/work-desk` แล้วตอบ A / B / ปัจจุบัน** → ลงของจริง (A = แก้ work-order-page แท็บขั้นงานเป็นตาราง · B = หน้าการผลิตเพิ่มแผงข้างใช้ controller เดิม)
