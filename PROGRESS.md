# PROGRESS — สถานะสด
> เขียนทับตอนปิดรอบ (ไม่ใช่ทุก commit) · ไม่สะสม log (log อยู่ git history) · ≤2.5KB · hook โหลดไฟล์นี้ทุก session · สมองของ Nami อ่านส่วนหัวไฟล์นี้เป็นความคืบหน้าของ project
