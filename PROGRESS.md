...
## NEXT
0. **ขึ้น main แล้ว (09-03 · `bd38e3f..f4e7c25` · build ผ่าน · Vercel deploy)**: โครงใหม่โมดูลผลิต + Alert B + แก้ hydration ใบผลิต · ต่อไป: เบสซ้อมจริง 2 บทบาทบนเว็บจริง (หัวหน้า → ใบผลิต แก้ให้/แจ้งปัญหา · บัญชีช่าง → ล็อกอินตกหน้างาน) → บอกจุดไม่ตรง
