...
- **เบสชอบทาง A และขอปรับก่อนเคาะลงจริง (09-02 กลางคืน):** เอา CTA “ลงมือ” ท้ายแถวออก · แยก “ผู้รับผิดชอบ” เป็นคอลัมน์ของตัวเอง · ใช้ hover + ลูกศรท้ายแถวสื่อว่ากดทั้งแถวเพื่อเปิดดูใบผลิต · หน้าลองยังไม่ลิงก์ ID ปลอมไป `/production/[id]` เพราะจะเจอใบไม่พบ · B และโหมดหน้างานยังคงปุ่มลงมือเดิม
...
## NEXT
1. **เบสดูทาง A รอบปรับที่ `/proto/production-module?v=desk&busy=1` แล้วเคาะสุดท้าย** — เช็กว่าแถวไม่มี CTA, ผู้รับผิดชอบแยกคอลัมน์ และลูกศร/hover สื่อการกดดูพอหรือยัง (branch `proto/production-module-2026-09-02`) · เคาะแล้ว → ลงของจริงพร้อมลิงก์ `/production/[id]` ด้วย ID จริง (ROADMAP §A2/§A3)
