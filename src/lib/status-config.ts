...
export const DELIVERY_STATUS_LABELS_CUSTOMER: Record<string, string> = {
  ...
  // "ตีกลับ" เป็นคำฝั่งทีม — ลูกค้าที่เพิ่งทักมาว่าของมีปัญหาอ่านแล้วเหมือนโดนปฏิเสธ
  // ทั้งที่ของกลับมาเพื่อให้เราแก้ให้ (ก้อน 1 · รอบแก้งาน)
  RETURNED: "ส่งกลับมาที่ร้าน",
};
