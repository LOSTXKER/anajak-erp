...
// ระดับนี้ไม่ใช่ "กี่วัน" — เวลาเป็นหน้าที่ของกำหนดส่ง ส่วนระดับคือลำดับคิวที่คนตัดสิน
// (เบสเคาะ 2026-09-18 หลังลองใส่ช่วงวันในป้ายแล้วมันไปทับความหมายของกำหนดส่ง)
...
/**
 * ป้าย blindShip บนจอที่แสดงคิวงาน (สถานี · คิวผลิต · จอทีวี · งานของฉัน)
 * รวมคำไว้ที่เดียว เพราะเดิมสี่จอเขียน "Blind ship" เอง ส่วนจอสถานีเขียนไทย —
 * ช่างคนเดียวกันเดินข้ามจอแล้วอ่านคนละคำสำหรับใบเดียวกัน
 * ใช้เป็น "ป้าย" เท่านั้น ห้ามเอาไปแทนประโยคเต็มบนใบออเดอร์/เอกสารพิมพ์
 * ซึ่งต้องบอกชื่อผู้ส่งบนกล่องด้วย
 */
export const BLIND_SHIP_LABEL = "ไม่ระบุผู้ส่ง";
