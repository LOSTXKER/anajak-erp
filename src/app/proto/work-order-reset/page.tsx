...
export default function ResetComparison() {
  ...
  return <main className="min-h-screen bg-bg px-4 py-5 text-strong sm:px-8"><div className="mx-auto max-w-[1600px] space-y-6">
    ...
    <header className="space-y-2 border-b border-divider px-5 py-4 sm:px-6"><Link className="inline-flex min-h-11 items-center gap-2 text-sm text-secondary" href="/proto"><ArrowLeft className="size-4" />หน้าลองทั้งหมด</Link><h1 className="text-2xl font-semibold">ใบผลิต จัดใหม่แบบ ERP</h1><p className="text-sm text-secondary">ข้อมูลตัวอย่างและการบันทึกจำลอง</p></header>
