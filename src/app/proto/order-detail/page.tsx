...
> = {
  current: {
    name: "ปัจจุบัน — การ์ดสามใบ ทุกช่องน้ำหนักเท่ากัน",
    idea: "เอาข้อมูลทั้งหมดใส่การ์ดให้ครบก่อน",
    summary:
      "หัวหน้าเป็นเลขที่ออเดอร์ตัวใหญ่ ชื่องานเป็นตัวจิ๋วใต้คำอธิบายหน้า · ใต้แถบสถานะเป็นการ์ด “สรุปออเดอร์” แล้วต่อด้วยการ์ดลูกค้ากับการ์ดจัดส่งวางคู่กัน · ในการ์ดทุกช่องหน้าตาเหมือนกันหมด (ป้ายเทาเล็ก + ค่าเข้มเล็ก) ต่างกันแค่สี่ช่องบนสุดที่ตัวใหญ่กว่า",
    tradeoff:
      "ข้อดีที่เสียไปถ้าเปลี่ยน: ทุกอย่างอยู่ในกรอบชัดเจน แยกเรื่องออกจากกันง่าย และทีมคุ้นตำแหน่งแล้ว",
  },
  calm: {
    name: "A · เรียบอย่างเอกสาร",
    idea: "ใบงานคือของที่ต้องอ่าน ไม่ใช่แดชบอร์ดที่ต้องสแกน",
    summary:
      "ถอดกรอบการ์ดออกทั้งหมด ใช้ที่ว่างกับเส้นบางเป็นตัวแบ่งแทน · ตัวหนังสือใหญ่ขึ้นหนึ่งขั้นทั้งหน้า ป้ายเล็กลงและจางลงจนอ่านเป็น “ป้าย” ทันที · ชื่องานขึ้นมาอยู่ใต้เลขที่เป็นบรรทัดจริง ไม่ใช่ตัวจิ๋ว · ทุกอย่างเรียงลงมาทางเดียว ไม่ต้องกวาดตาสลับซ้าย-ขวา",
    tradeoff:
  ...
  lead: {
    name: "B · หัวใบนำสายตา",
    idea: "เปิดมาต้องมีจุดให้ตาตกก่อนหนึ่งจุด แล้วค่อยไหลลง",
    summary:
      "รวมทุกอย่างที่ตัดสินใจได้ทันที (เลขที่ · ชื่องาน · สถานะลูกค้า · ความเร่งด่วน · ลูกค้า · กำหนดส่ง · จำนวน · ยอด · แถบสถานะ) ไว้ในแผ่นเดียวบนสุด มีแถบสีบางด้านซ้ายเมื่อใบนั้นเร่งด่วน · ที่เหลือลดเสียงลงหมด เป็นการ์ดเงียบตัวเล็กสองคอลัมน์",
    tradeoff:
      "หัวใบสูง กินจอแรกไปมาก บนโน้ตบุ๊กจอเตี้ยจะเห็นเนื้อหาน้อยลง · ของที่ไม่ได้อยู่บนหัวถูกลดความสำคัญเท่ากันหมด แม้บางใบเรื่องสำคัญจะอยู่ข้างล่าง",
  },
  dense: {
    name: "C · แน่นครบจอ",
    idea: "คนเปิดใบงานคือคนที่กำลังคุยโทรศัพท์อยู่ — ต้องหาเจอโดยไม่ต้องเลื่อน",
    summary:
      "อัดลงจอเดียว 3 คอลัมน์ · แถวเป็น “ป้ายซ้าย ค่าขวา” มีเส้นบางทุกแถว ตากวาดลงตามคอลัมน์ป้ายได้เร็ว · หัวใบยุบเหลือแถวเดียว (เลขที่ + ชื่องาน + ป้าย + ปุ่ม) · ตัวหนังสือเล็กลงหนึ่งขั้น หัวข้อกลุ่มเป็นแถบเทาบาง",
    tradeoff:
