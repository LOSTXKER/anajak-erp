...
> = {
  current: {
    ...
    summary:
      "นี่คือ component ตัวจริงของหน้า /orders/[id] (PageHeader + OrderOverviewTab) ต่างจากหน้าจริงแค่ข้อมูลปลอม · หัวใบเหลือ เลขที่ · ชื่องาน · ป้ายสถานะ/ความเร่งด่วน · แถบสถานะ · ปุ่มขั้นต่อไป — ส่วนกำหนดส่ง/จำนวน/ยอด อยู่บนสุดของการ์ด “ข้อมูลออเดอร์”",
    tradeoff:
