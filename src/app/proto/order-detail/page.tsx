...
> = {
  ...
  lead: {
    ...
    summary:
      "หัวใบเหลือ เลขที่ · ชื่องาน · ป้ายสถานะลูกค้า/ความเร่งด่วน · แถบสถานะ 11 ขั้น · ปุ่มขั้นต่อไป — มีแถบสีบางด้านซ้ายเมื่อใบนั้นเร่งด่วน · เนื้อหาที่เหลือเป็นการ์ดเงียบสองคอลัมน์ ตัวเล็กกว่าหัวชัดเจน",
    tradeoff:
