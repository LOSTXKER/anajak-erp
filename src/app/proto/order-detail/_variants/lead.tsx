 ...
 * → รวมทุกอย่างที่ตัดสินใจได้ทันที (เลขที่ · ชื่องาน · สถานะ · ลูกค้า · กำหนดส่ง ·
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 max-w-[58ch] text-sm leading-6 text-secondary [overflow-wrap:anywhere]">
                  {order.title}
                </p>
              </div>
            </div>
