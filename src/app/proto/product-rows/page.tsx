...
export default function ProductRowsProtoPage() {
  ...
  const notes = [
    ...
    "แถวหลัก 8 คอลัมน์ในแบบ A/B/C ใช้ความกว้างคอลัมน์ชุดเดียวกับตารางสต๊อกของจริง (เบสสั่ง 08-03 ให้คอลัมน์ทุกตารางในชุดงานตรงกัน) — สิ่งที่ต่างกันคือแถวลูกใต้แถวหลักเท่านั้น",
    "ทั้ง 3 แบบไม่มีกล่องพื้นเทาแล้ว: รายละเอียดใต้แถวเป็นพื้นขาว มีเส้นบางด้านซ้ายบอกว่าเป็นลูกของแถวบน (ตามที่เบสบอกว่าไม่ชอบพื้นหลังเทา)",
  ];
    ...
    <main className="min-h-screen bg-surface-muted px-4 py-8 text-strong sm:px-6 lg:px-10">
      <div className="mx-auto max-w-[1500px]">
        ...
        <p className="mt-2 max-w-4xl text-sm text-secondary">
          ...
          หน้านี้วางกล่องเทาของจริงตอนนี้ เทียบกับ 3 ทางที่ทุกสินค้าอยู่ในตารางเดียวกัน — ต่างกันที่ว่า “ของที่เกินหนึ่งแถว” (ไซส์หลายไซส์ สเปคตัดเย็บ) ไปอยู่ตรงไหน
        </p>
