...
const NOTES = [
  ...
  "ตัวเลขความยาววัดจริงบนจอกว้าง 1,440 จุดภาพ (ใบเล็ก · กางขั้นแรกที่ทำได้ไว้เหมือนกันทุกแบบ) — ของจริง 3,367 · A 1,688 · B 1,011 · B+ 1,150 · C 1,646 · D 1,300 · บนจอ 390 ไม่มีแบบไหนล้นแนวนอน",
