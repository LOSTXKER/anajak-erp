...
const OPTIONS = [
  ...
  { value: "station", label: "B · จอสถานีของหัวหน้า" },
...
const NOTES = [
  ...
  "ตัวเลขความยาววัดจริงบนจอกว้าง 1,440 จุดภาพ (ใบเล็ก · กางขั้นแรกที่ทำได้ไว้เหมือนกันทุกแบบ) — ของจริง 3,367 · A 1,688 · B 1,011 · C 1,646 · บนจอ 390 ไม่มีแบบไหนล้นแนวนอน",
      ...
      <div className="mx-auto max-w-[1500px]">
        ...
        <section className="card-surface mt-8 rounded-2xl p-5">
          ...
          <p className="mt-1 text-xs text-muted">
            รื้อการจัดวาง ไม่ได้รื้อของ — ทั้งสามแบบยังมีของครบเท่าเดิม แค่คนละที่
          </p>
            ...
            <table className="w-full min-w-[720px] text-left text-xs">
              <thead className={cn(TABLE_HEAD_SURFACE, "text-muted")}>
                <tr className="border-b border-divider">
                  ...
                  <th className="py-2 pr-3 font-medium">B · จอสถานีของหัวหน้า</th>
