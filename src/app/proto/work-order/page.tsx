...
const NOTES = [
  ...
  "ไม่เอาของที่เบสสั่งลบกลับมา: ไม่มีผังสายพานเป็นพระเอก · ไม่มีจอสถานีแยก · ไม่มีแท็บ",
] as const;
    ...
    <main className="min-h-screen bg-surface-muted px-4 py-8 text-strong sm:px-6 lg:px-10">
      <div className="mx-auto max-w-[1500px]">
        ...
        <p className="mt-2 max-w-4xl text-sm text-secondary">
          ...
          สามทางข้างล่างคิดคนละอย่างว่าอะไรควรนำสายตา — ตารางทุกขั้นเท่ากัน / ขั้นที่ต้องทำตอนนี้ / เส้นเวลา
        </p>
