...
> = {
  ...
  dense: {
    ...
    summary:
      "การ์ดกรองบีบจาก 87px เหลือ 56px (ไอคอน–ชื่อ–ตัวเลข อยู่บรรทัดเดียว) · คอลัมน์กลางเป็น “สถานะ”: จุดสีบอกสภาพงาน + ขั้นที่ค้างอยู่ เช่น “เตรียมเสื้อ · DTF” (อัปเดตตามของจริง 2026-08-31 หลังเบสสั่งตัดคำว่า “กำลังผลิต” ที่ซ้ำทุกแถวออก) · แถวลดจาก 107px เหลือ 61px · ผลคือเห็น 9 แถวต่อจอ แทนที่จะเป็น 5 และทั้งหน้าสั้นลงจาก 1,676px เหลือ 1,104px",
    tradeoff:
