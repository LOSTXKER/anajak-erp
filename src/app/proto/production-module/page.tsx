...
> = {
  ...
  desk: {
    ...
    summary:
      "เปิดมาเห็น 4 ตัวเลขทันที: เลยกำหนด · ติดปัญหา · ของร้านนอกครบกำหนด · พร้อมส่ง — กดตัวเลขไหน รายการข้างล่างเหลือแค่กองนั้น · รายการไม่เรียงตามสถานะออเดอร์ แต่จัดเป็น “กอง” ตามความรีบ (ติดปัญหา → ของร้านนอกครบกำหนด → ลงมือได้ → รอของกลับ → พร้อมส่ง) ทุกแถวมีบรรทัด “ตอนนี้อยู่ที่” + ร้านนอก/วันกลับ + ปุ่มเดียว · รอบพิมพ์ คลังฟิล์ม คิวร้านนอก ไม่มีหน้าแยกอีก — เป็นกองบนโต๊ะเดียวกัน · โหมดหน้างาน = โต๊ะเดียวกันย่อเหลือสถานีของฉัน การ์ดใหญ่ ปุ่มสูง 56px",
    tradeoff:
...
const OUT_OF_SCOPE = [
  "หน้าใบผลิต /production/[id] ยังไม่ได้ออกแบบใหม่ (ROADMAP §A) — กดเข้าใบจากหน้าลองนี้ยังไม่ทำอะไร · รูปร่างของมันควรตามทางที่เลือกจากหน้านี้ก่อน",
