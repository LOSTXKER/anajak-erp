...
export function OrderStatusBar({
  ...
  return (
    /* เส้นเดียวอยู่ "ข้างบน" เท่านั้น — แยกตัวตนของใบ (ชื่อ/สถานะ/ปุ่ม) ออกจากความคืบหน้า
       เดิมเป็น border-y คือมีเส้นล่างด้วย พอถัดลงไปเป็นแถบแท็บที่มีเส้นของตัวเองอีก
       จะได้เส้นคู่ชิดกันโดยไม่ได้แบ่งอะไรเพิ่ม (เบสสั่ง 2026-08-30 ให้ส่วนบน minimal) */
    <div className="border-t border-divider pb-1 pt-4">
