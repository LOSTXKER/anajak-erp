    ...
    <div className={cn("mt-2 p-3", RADIUS.item)}>
      ...
      <div className="flex items-end gap-2">
        <div className="flex-1 space-y-1.5">
          ...
          <label className={cn(DASHED_INTERACTIVE, RADIUS.item, CONTROL_MIN_H, "flex w-fit cursor-pointer items-center gap-1.5 px-3 py-1 text-xs text-muted transition-colors")}>
