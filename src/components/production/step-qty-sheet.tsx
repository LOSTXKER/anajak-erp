        ...
        <div className="space-y-3">
          ...
          {!willComplete && (
            <button
              ...
              className={cn(DASHED_INTERACTIVE, "min-h-11 w-full rounded-lg px-3 py-2.5 text-sm font-medium text-secondary transition-colors active:bg-interactive-pressed dark:active:bg-interactive-pressed")}
            >
