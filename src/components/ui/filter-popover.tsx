...
/* ============================================================
   ...
   ทำเป็นของกลางสำหรับเงื่อนไขรองที่ไม่ควรกินพื้นที่ตลอด (เช่นหน้าผลิต)
   หน้าออเดอร์เลิกใช้กับช่วงวันที่/ช่องทาง/ประเภทตั้งแต่ 2026-08-27 เพราะสามตัวนี้ใช้ประจำ
   ============================================================ */
