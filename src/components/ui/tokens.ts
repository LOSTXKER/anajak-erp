...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
export const RADIUS = {
  /* ชิ้นเล็ก 8 → 6px (UI-2026 เฟส 2) — ของสูง 28-36px ที่โค้ง 8px อ่านเป็นเม็ดยาเบลอ
     และเมื่อเรียงติดกันในตาราง ขอบจะไม่ตรงแนวจนตาจับ pattern ยาก
     surface คง 8px ตามที่เบสเคาะไว้ 2026-08 — กติกาเดียว: ชั้นในโค้งไม่เกินชั้นนอก */
  /** 6px — ชิ้นเล็กในรายการ: ตัวเลือกในเมนู · ปุ่มในแถบสลับ · แถบโครงร่างตอนโหลด */
  item: "rounded-md",
  /** 6px — ช่องกรอก/ช่องเลือก/กล่องข้อความ */
  field: "rounded-md",
  /** 6px — กล่องย่อย · รูปย่อ · ป้ายสี่เหลี่ยม */
  inner: "rounded-md",
