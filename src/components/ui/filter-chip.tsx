    ...
    <button
      ...
      className={cn(CONTROL_MIN_H, "touch-manipulation whitespace-nowrap rounded-full px-3 py-1 text-xs font-medium transition-colors active:scale-[0.98]", FOCUS_BUTTON,
        selected
          ...
          ? "bg-interactive-selected text-interactive-selected-text hairline-ring"
          : "bg-field text-secondary hairline-ring hover:bg-interactive-hover hover:text-strong active:bg-interactive-pressed active:text-strong",
        className,
      )}
    >
      {children}
