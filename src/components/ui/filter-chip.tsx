    ...
    <button
      ...
      className={cn(CONTROL_MIN_H, "touch-manipulation whitespace-nowrap rounded-full px-3 py-1 text-xs font-medium transition-colors", FOCUS_BUTTON,
        selected
          ...
          : "bg-white text-slate-600 hairline-ring hover:bg-slate-100 hover:text-slate-900 dark:bg-white/[0.06] dark:text-slate-300 dark:hover:bg-white/10 dark:hover:text-white",
        className,
      )}
    >
      {children}
