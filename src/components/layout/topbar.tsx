            ...
            <div className={cn(OVERLAY_PANEL, "fixed left-2 right-2 top-16 z-50 overflow-hidden sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-96")}>
                ...
                {notifData?.notifications && notifData.notifications.length > 0 ? (
                  notifData.notifications.map((notif) => (
                    ...
                    <Link
                      ...
                      className={`flex gap-2 border-b border-slate-50 px-3.5 py-2.5 transition-colors last:border-0 hover:bg-slate-100 dark:border-slate-800/50 dark:hover:bg-slate-800/50 ${
                        !notif.isRead
              ...
              <div className="border-t border-slate-100 dark:border-slate-800">
                <Link
                  ...
                  className="block px-3.5 py-2 text-center text-xs font-medium text-slate-600 transition-colors hover:bg-slate-100 hover:text-blue-600 dark:text-slate-400 dark:hover:bg-slate-800/50 dark:hover:text-blue-400"
                >
                  ดูทั้งหมด
                </Link>
              </div>
