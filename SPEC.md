...
- [x] **สถานะชี้ไม่กลืนกับพื้น** — control/แถว/เมนูที่กดได้ใช้สี hover semantic คนละระดับกับ page, card และ sunk panel อย่างเห็นได้ชัด · active/focus ยังเด่นกว่า hover และ dark theme อ่านลำดับเดียวกัน
