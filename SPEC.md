...
- [x] **จุดโฟกัสชัดใน 3 วินาที** — งานเสี่ยง/งานค้างและ action หลักมาก่อนสถิติสะสม · desktop Sidebar แสดงทุกโมดูลที่มีสิทธิ์เป็นหมวดแบบแบน ไม่มีพื้น/สีครอบหมวด และใช้น้ำเงินเฉพาะ active item โดยไม่ซ่อนใน disclosure ส่วนมือถือคงงานหลัก 4 รายการและเปิดที่เหลือผ่าน “เพิ่มเติม”
- [x] **ชุดสีเดียวทั้งระบบทั้งสองธีม** — ล็อกน้ำเงินแบรนด์ `#3973b2` ไว้ · Light page/workspace/chrome เป็นผืนขาวเดียว · Dark กลับเป็นผืนดำ neutral เดียว · เนื้อหาหลักวางบนผืนโดยตรง, card รองมี hairline edge+เงาสั้นตามธีม และ overlay ลอยสูงกว่าอย่างชัดเจน · semantic text ผ่าน WCAG AA · public/print ไม่ถูกธีมหลังบ้านรบกวน
- [x] **สถานะโต้ตอบชัดแต่ไม่เป็นแถบหนัก** — navigation/row/clickable card ใช้ neutral hover ที่ครอบ hit areaจริง; card ยก 1px แล้วคืนตำแหน่งตอนกด, ปุ่มมี tactile pressed state · active navigation เป็นข้อความน้ำเงิน+indicator บาง ส่วนตัวกรอง/ขั้นสถานะเลือกใช้ข้อความ neutral+เส้นใต้ · focus ยังใช้น้ำเงิน · disabled แยกชัด · ข้อความบนทุก state ผ่าน WCAG AA
- [x] **ตัวกรองธรรมดาแบบ minimal** — ตัวเลือกไม่เกิน 5 ตัวใช้ `FilterChip` กลางเป็นข้อความ neutral ไม่มีกรอบกล่อง พื้นสี เงา หรือ radius · selected ใช้เส้นใต้และน้ำหนักข้อความพร้อม `aria-pressed` · มือถือยังแตะได้อย่างน้อย 44px
...
- [x] **พื้นผิวแยกตามหน้าที่ ไม่กลืนกัน** — table/status rail วางตรงบน canvas พร้อม divider; หัวตารางเป็น neutral band ต่อเนื่องและไม่ย้อม hover รายช่อง · card จริงเป็นขาว/neutral dark พร้อม hairline edge+เงาสั้น · field ในฟอร์มมี resting boundary ที่ไม่แข่งกับเนื้อหา · toolbar/secondary action โปร่งมีขอบบาง · overlay มี elevation สูงสุด · focus/error/selected ต้องชนะสถานะปกติอย่างชัดเจน
- [x] **รายการงานแยกเป็นการ์ดที่อ่านออกทันที** — หน้าเปิดงานและหน้าแก้ไขใช้หนึ่งรายการต่อหนึ่ง card ขาวที่แยกจากผืนด้วย depth เบา · CTA “เพิ่มรายการ” อยู่เหนือ list และเห็นได้ก่อนเลื่อน · Light workspace เป็นขาวต่อเนื่อง โดยยังแยก hierarchy ได้ทั้ง desktop/mobile
