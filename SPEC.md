...
- [x] **พื้นผิวแยกตามหน้าที่ ไม่กลืนกัน** — `Section` ที่เป็นกลุ่มหลักและ `DataTable` อยู่ใน panel เดียวกับเนื้อหาที่สัมพันธ์กัน (ยกเว้นหน้ารายการที่เคาะว่าไม่มีกล่องครอบ ใช้ `bordered={false} flush`); หัว panel/หัวตาราง/แถวใช้ divider ต่อเนื่องและไม่ย้อม hover รายช่อง · panel เป็นขาว/neutral dark พร้อม hairline edgeไร้เงา · field/toolbar/secondary action ใช้พื้น panel+ขอบบาง · overlay มี elevation สูงสุด · focus/error/selected ต้องชนะสถานะปกติอย่างชัดเจน
