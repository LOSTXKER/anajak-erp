...
- [x] **ชุดสีเดียวทั้งระบบทั้งสองธีม** — ล็อกน้ำเงินแบรนด์ `#3973b2` ไว้ · Light workspace เป็น off-white `#fafafa` โดย chrome/panel เป็นขาว · Dark workspace เป็นดำโดย panel ยกขึ้นหนึ่ง neutral step · panel ใช้เส้น 1px, มุม 8px และไม่มีเงาตกแต่ง; overlay เท่านั้นที่ลอยด้วยเงา · semantic text ผ่าน WCAG AA · public/print ไม่ถูกธีมหลังบ้านรบกวน
