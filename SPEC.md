...
- [x] **จุดโฟกัสชัดใน 3 วินาที** — งานเสี่ยง/งานค้างและ action หลักมาก่อนสถิติสะสม · desktop Sidebar แสดงทุกโมดูลที่มีสิทธิ์เป็นหมวดแบบแบน ไม่มีพื้น/สีครอบหมวด และใช้น้ำเงินเฉพาะ active item โดยไม่ซ่อนใน disclosure; ปุ่มหุบ/กางเป็น chevron ghost 32px ใน gutter ซ้ายของ topbar ไม่มีชิ้นส่วนคาบหรือยื่นจากเส้น sidebar, ไม่ทับลิงก์โลโก้/ช่องค้นหา และคง focus/ARIA/เป้านิ้ว coarse pointer เดิม · ส่วนมือถือคงงานหลัก 4 รายการและเปิดที่เหลือผ่าน “เพิ่มเติม”
