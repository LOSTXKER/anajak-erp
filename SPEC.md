...
- [x] **ตัวกรองแบบปุ่มเรียบและกะทัดรัด** — ตัวเลือกไม่เกิน 5 ตัวใช้ `FilterChip` กลางแบบแบน มุม 8px ไม่มีเงาและไม่จองช่องไอคอนล่องหน · selected มีพื้น/เส้น/น้ำหนักข้อความพร้อม `aria-pressed` · มือถือยังแตะได้อย่างน้อย 44px
