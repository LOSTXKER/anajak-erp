...
- [x] **ใบผลิตเป็น job traveler เดียว** — หัวใบสรุปเลขงาน/ลูกค้า/กำหนด/จำนวน/ความคืบหน้า · “งานถัดไป” อยู่ติดกับข้อมูลที่ใช้ตัดสินใจ · แบบ/ไซส์/ขั้น/เสื้อ/วัตถุดิบแยกชั้นชัดโดยไม่วาด action งานเดียวซ้ำ · Station variant แสดงเฉพาะสถานีปัจจุบันและข้อมูลจำเป็น ไม่แสดง MaterialUsage/เงิน
