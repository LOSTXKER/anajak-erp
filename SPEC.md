...
- [x] **ชุดสีเดียวทั้งระบบทั้งสองธีม** — ล็อกน้ำเงินแบรนด์ `#3973b2` ไว้ · บันไดความลึกอ่านทิศเดียวกันทั้งสองธีม: chrome (กรอบเว็บ) จมสุด < bg (ผืนเนื้อหา) < surface (การ์ด) — Light `#f2f3f5` < `#fbfbfc` < `#ffffff` · Dark `#0a0a0b` < `#0e0e10` < `#161618` ห้ามดำสนิท (แก้ 2026-08-25 UI-2026 เฟส 1 · เดิมสองธีมทำคนละทิศ) · panel ใช้เส้น 1px, มุม 8px และไม่มีเงาตกแต่ง; overlay เท่านั้นที่ลอยด้วยเงา · semantic text ผ่าน WCAG AA · public/print ไม่ถูกธีมหลังบ้านรบกวน
