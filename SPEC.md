...
- [x] **ใบผลิตเป็น job traveler เดียว** — มีทางกลับคิวเพียงจุดเดียวและไม่วาด breadcrumb/local module nav ที่ชวนออกจากใบงาน · หัวใบแสดงเฉพาะบริบทที่จำเป็น แล้ว workspace แรกตอบพร้อมกันว่า **ตอนนี้ทำอะไร / พร้อมหรือยัง / ใช้แบบและจำนวนไหน / กดปุ่มใด** โดยไม่แยกข้อมูลตัดสินใจไว้คนละแท็บ · เสื้อที่เป็นงานปัจจุบันหรือใบเก่าที่ระบบยืนยันยอดไม่ได้อยู่ติด action และต้องยืนยันก่อนเริ่มรีด · เสื้อ/วัตถุดิบส่วนรองกับเส้นทางงานทั้งหมดเป็น disclosure อ่านเมื่อจำเป็นและไม่ทำ mutation ซ้ำ · Station variant คงหน้าเส้นตรงเฉพาะสถานีปัจจุบัน ไม่แสดง disclosure ของ ERP, MaterialUsage หรือเงิน
