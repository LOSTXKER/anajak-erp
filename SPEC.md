...
- [x] **ใบผลิตเป็น job traveler เดียว** — มีทางกลับคิวเพียงจุดเดียวและไม่วาด breadcrumb/local module tabs ที่ชวนออกจากใบงาน · หัวใบสรุปเลขงาน/ลูกค้า/กำหนด/จำนวน/ความคืบหน้า · แยก “งานที่ทำได้ตอนนี้” ออกจาก “รอต่อจากนี้” อย่างชัดเจน · แบบ/จำนวน/ประวัติขั้น/เสื้อ/วัตถุดิบเป็นข้อมูลชั้นรองด้านล่างโดยไม่วาด action งานเดียวซ้ำ · Station variant แสดงเฉพาะสถานีปัจจุบันและข้อมูลจำเป็น ไม่แสดง MaterialUsage/เงิน
