...
- [x] **หน้าปกติไม่มีคำอธิบายค้างใต้หัวข้อ** — PageHeader/PageShell/Section ใช้ชื่อ+metadata ที่จำเป็น; static guidance เปิดดูผ่าน HelpTip ส่วน warning/error/validation/blocker/legal/action consequence ยังเห็นตรงหน้าและใช้ได้บน mouse/keyboard/touch
