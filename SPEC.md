...
- [x] **จุดโฟกัสชัดใน 3 วินาที** — งานเสี่ยง/งานค้างและ action หลักมาก่อนสถิติสะสม · desktop Sidebar แสดงทุกโมดูลที่มีสิทธิ์เป็นหมวดแบบแบน ไม่มีพื้น/สีครอบหมวด และใช้น้ำเงินเฉพาะ active item โดยไม่ซ่อนใน disclosure; ปุ่มหุบ/กางอยู่ใน action slot 56px แรกของ topbar ที่ต่อจากขอบ sidebar โดยไม่คาบเส้น ใช้สัญลักษณ์แผงซ้ายเปิด/ปิดในปุ่มมาตรฐาน 36px (coarse pointer 44px) เพื่อไม่ให้อ่านเป็นปุ่มย้อนกลับ, ไม่ทับลิงก์โลโก้/ช่องค้นหา และคง focus/ARIA เดิม · ส่วนมือถือคงงานหลัก 4 รายการและเปิดที่เหลือผ่าน “เพิ่มเติม”
