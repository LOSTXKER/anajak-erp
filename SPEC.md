...
- [x] **ชุดสีเดียวทั้งระบบทั้งสองธีม** — ล็อกน้ำเงินแบรนด์ `#3973b2` ไว้ · Light page/workspace/chrome เป็นผืนขาวเดียว · Dark กลับเป็นผืนดำ neutral เดียว · เนื้อหาหลักวางบนผืนโดยตรง, card รองต่างชั้นด้วย neutral fill ไร้เงา และ overlay เท่านั้นที่ลอย · semantic text ผ่าน WCAG AA · public/print ไม่ถูกธีมหลังบ้านรบกวน
- [x] **สถานะโต้ตอบชัดแต่ไม่เป็นแถบหนัก** — navigation/clickable card ใช้ neutral hover ที่ครอบ hit areaจริง; active navigation เป็นข้อความน้ำเงิน+indicator บาง ส่วนตัวกรอง/ขั้นสถานะเลือกใช้ข้อความ neutral+เส้นใต้ · pressed เข้มกว่า hover · focus ยังใช้น้ำเงิน · disabled แยกชัด · ข้อความบนทุก state ผ่าน WCAG AA
