...
> ฉบับเต็มเดิม: `git show e9640f8:docs/DESIGN.md` · กติกา: ≤4KB · คำห้าม ≤8 · กฎ visual = ผลลัพธ์ที่เจ้าของเคาะ
## ตัวตนบน UI
...
- สัญญาหน้าผลิต/หน้างาน: `SPEC.md` §การผลิต
...
- ตอนนี้ใช้ใบผลิตแบบฟอร์มเหมือนหน้าออเดอร์ (ทุกขั้นปิดด้วยปุ่ม) แทนแบบ E (เบสเคาะ 2026-09-08) · ปุ่มลงมือ/ตรวจรับอยู่ในกล่องขั้น หัวใบ = "ถัดไป: <ขั้น>" (เบสเคาะ 2026-09-10)
