...
async function main() {
  ...
  const product1 = await prisma.product.create({
    data: {
      ...
      variants: {
        create: [
          { size: "S", color: "Black", sku: "TS-MIDNIGHT-CAT-S-BLK", stock: 15 },
          { size: "M", color: "Black", sku: "TS-MIDNIGHT-CAT-M-BLK", stock: 25 },
          { size: "L", color: "Black", sku: "TS-MIDNIGHT-CAT-L-BLK", stock: 20 },
          { size: "XL", color: "Black", sku: "TS-MIDNIGHT-CAT-XL-BLK", stock: 10 },
          { size: "S", color: "White", sku: "TS-MIDNIGHT-CAT-S-WHT", stock: 10 },
          { size: "M", color: "White", sku: "TS-MIDNIGHT-CAT-M-WHT", stock: 20 },
          { size: "L", color: "White", sku: "TS-MIDNIGHT-CAT-L-WHT", stock: 15 },
          { size: "XL", color: "White", sku: "TS-MIDNIGHT-CAT-XL-WHT", stock: 5 },
        ],
      },
    },
  });
  ...
  await prisma.product.create({
    data: {
      ...
      variants: {
        create: [
          { size: "M", color: "White", sku: "TS-SUMMER-VIBE-M-WHT", stock: 30 },
          { size: "L", color: "White", sku: "TS-SUMMER-VIBE-L-WHT", stock: 25 },
          { size: "XL", color: "White", sku: "TS-SUMMER-VIBE-XL-WHT", stock: 15 },
          { size: "M", color: "Cream", sku: "TS-SUMMER-VIBE-M-CRM", stock: 20 },
          { size: "L", color: "Cream", sku: "TS-SUMMER-VIBE-L-CRM", stock: 15 },
        ],
      },
    },
  });
  ...
  await prisma.product.create({
    data: {
      ...
      variants: {
        create: [
          { size: "FREE", color: "Natural", sku: "TB-LOGO-ECO-F-NAT", stock: 50 },
          { size: "FREE", color: "Black", sku: "TB-LOGO-ECO-F-BLK", stock: 30 },
        ],
      },
    },
  });
