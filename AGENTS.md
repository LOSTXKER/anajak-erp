...
- ทุกงานสร้าง แก้ หรือรีวิว UI รวมข้อความ/ฟอร์ม/หน้าลอง ต้องอ่าน [ui-guidance](/Users/lostxker/dev/Git/bestos-brain/global-skills/ui-guidance/SKILL.md) ร่วมกับ DESIGN/SPEC; ตรวจตามขนาดงานและไม่ขยายโจทย์ที่อนุมัติ
- ทิศปัจจุบันอยู่ DESIGN; มีหลายทางเลือกในการเปลี่ยนหน้าจริงให้เบสเคาะก่อน ไม่สร้าง `/proto` เว้นแต่เบสสั่ง
- คงข้อมูลจริง ปุ่ม และคำช่วยที่จำเป็นต่อการตัดสินใจ ลงมือ หรือแก้ผิดไว้ตรงจุดใช้ รวม warning, validation, เหตุล็อก/สิทธิ์, ผลสำคัญและขั้นถัดไป; ตัดคำโปรย/คำซ้ำ รายละเอียดเสริมเปิดเพิ่มได้ด้วยคีย์บอร์ดและจอทัช ไม่ซ่อนคำช่วยจำเป็นใน tooltip
