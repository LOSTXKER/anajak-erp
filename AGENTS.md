...
3. **UI ที่มีหลายทาง** → ทำหน้าลอง `/proto/<slug>` เทียบ 2-4 ทางให้เบสเลือกก่อน (ทะเบียน `src/app/proto/_registry.ts` · skill `/proto` ของ bestos) — **ห้ามรื้อของจริงก่อนเคาะ** · **ก่อนส่งหน้าลองให้เบส: ผ่าน impeccable (`critique`/`polish`) + กฎ 3 ชั้น `docs/DESIGN.md` §ลำดับความสำคัญทางสายตา** (เบสทักเรื่อง "text ธรรมดาต่อกันด้วยจุด" มาแล้ว 3 ครั้ง)
